...
func (*EventSinkConfig_Provider) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{11, 0}
}
...
func (*EventSinkConfig_Route) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{11, 1}
}
...
func (*EventSinkConfig_Route_KeyValuePair) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{11, 1, 0}
}
...
func (*EventSinkConfig_Route_EventTypeKeysValues) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{11, 1, 1}
}
...
func (*TokenIntrospectConfig_Offline) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{16, 2}
}
...
func (*TokenIntrospectConfig_Online) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{16, 3}
}
...
func (*TokenIntrospectConfig_Claim) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{16, 4}
}
...
func (*EntityMatchingPipelineConfig_PropertyMapping) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{19, 1}
}
...
func (*RegisterCapturePipelineTopicConfig_Script) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{26, 0}
}
...
const file_indykite_config_v1beta1_model_proto_rawDesc = "" +
	...
	"deleteTime\x12\x12\n" +
	"\x04etag\x18\t \x01(\tR\x04etag\"\x87\x01\n" +
	"\fDBConnection\x12\x19\n" +
	"\x03url\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x03url\x12#\n" +
	"\busername\x18\x02 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\busername\x12#\n" +
	"\bpassword\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\bpassword\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\"\x86\a\n" +
	...
	"\x0ereplica_region\x18\x10 \x01(\tR\rreplicaRegion\x12J\n" +
	"\rdb_connection\x18\x11 \x01(\v2%.indykite.config.v1beta1.DBConnectionR\fdbConnection\"\xd8\x05\n" +
	"\vApplication\x124\n" +
	"\x02id\x18\x01 \x01(\tB$\xfaB!r\x1f\x10\x16\x18\xfe\x012\x18^[A-Za-z0-9-_:]{22,254}$R\x02id\x12A\n" +
	"\x04name\x18\x02 \x01(\tB-\xfaB*r(\x10\x02\x18?2\"^[a-z](?:[-a-z0-9]{0,61}[a-z0-9])$R\x04name\x12-\n" +
	"\fdisplay_name\x18\x03 \x01(\tB\n" +
	...
	"\x16api_access_restriction\x18\x0f \x03(\tR\x14apiAccessRestriction\"\xf9\x05\n" +
	...
	"\x14application_agent_id\x18\t \x01(\tB$\xfaB!r\x1f\x10\x16\x18\xfe\x012\x18^[A-Za-z0-9-_:]{22,254}$R\x12applicationAgentId\x12;\n" +
	...
	"\x06Script\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\"\xd3\x02\n" +
	"\x1aCapturePipelineTopicConfig\x12.\n" +
	"\x13capture_pipeline_id\x18\x06 \x01(\tR\x11capturePipelineId\x12(\n" +
...
var file_indykite_config_v1beta1_model_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_indykite_config_v1beta1_model_proto_goTypes = []any{
	...
	(*DBConnection)(nil),                                 // 11: indykite.config.v1beta1.DBConnection
	(*ApplicationSpace)(nil),                             // 12: indykite.config.v1beta1.ApplicationSpace
	(*Application)(nil),                                  // 13: indykite.config.v1beta1.Application
	(*ApplicationAgent)(nil),                             // 14: indykite.config.v1beta1.ApplicationAgent
	(*ApplicationAgentCredential)(nil),                   // 15: indykite.config.v1beta1.ApplicationAgentCredential
	(*ServiceAccount)(nil),                               // 16: indykite.config.v1beta1.ServiceAccount
	(*ServiceAccountCredential)(nil),                     // 17: indykite.config.v1beta1.ServiceAccountCredential
	(*ConfigNode)(nil),                                   // 18: indykite.config.v1beta1.ConfigNode
	(*AuthorizationPolicyConfig)(nil),                    // 19: indykite.config.v1beta1.AuthorizationPolicyConfig
	(*EventSinkConfig)(nil),                              // 20: indykite.config.v1beta1.EventSinkConfig
	(*KafkaSinkConfig)(nil),                              // 21: indykite.config.v1beta1.KafkaSinkConfig
	(*AzureEventGridSinkConfig)(nil),                     // 22: indykite.config.v1beta1.AzureEventGridSinkConfig
	(*AzureServiceBusSinkConfig)(nil),                    // 23: indykite.config.v1beta1.AzureServiceBusSinkConfig
	(*ConsentConfiguration)(nil),                         // 24: indykite.config.v1beta1.ConsentConfiguration
	(*TokenIntrospectConfig)(nil),                        // 25: indykite.config.v1beta1.TokenIntrospectConfig
	(*ConsentDataPoint)(nil),                             // 26: indykite.config.v1beta1.ConsentDataPoint
	(*IngestPipelineConfig)(nil),                         // 27: indykite.config.v1beta1.IngestPipelineConfig
	(*EntityMatchingPipelineConfig)(nil),                 // 28: indykite.config.v1beta1.EntityMatchingPipelineConfig
	(*ExternalDataResolverConfig)(nil),                   // 29: indykite.config.v1beta1.ExternalDataResolverConfig
	(*TrustScoreDimension)(nil),                          // 30: indykite.config.v1beta1.TrustScoreDimension
	(*TrustScoreProfileConfig)(nil),                      // 31: indykite.config.v1beta1.TrustScoreProfileConfig
	(*KnowledgeQueryConfig)(nil),                         // 32: indykite.config.v1beta1.KnowledgeQueryConfig
	(*RegisterCapturePipelineConfig)(nil),                // 33: indykite.config.v1beta1.RegisterCapturePipelineConfig
	(*CapturePipelineConfig)(nil),                        // 34: indykite.config.v1beta1.CapturePipelineConfig
	(*RegisterCapturePipelineTopicConfig)(nil),           // 35: indykite.config.v1beta1.RegisterCapturePipelineTopicConfig
	(*CapturePipelineTopicConfig)(nil),                   // 36: indykite.config.v1beta1.CapturePipelineTopicConfig
	(*CapturePipelineTopicScriptConfig)(nil),             // 37: indykite.config.v1beta1.CapturePipelineTopicScriptConfig
	(*EventSinkConfig_Provider)(nil),                     // 38: indykite.config.v1beta1.EventSinkConfig.Provider
	(*EventSinkConfig_Route)(nil),                        // 39: indykite.config.v1beta1.EventSinkConfig.Route
	nil,                                                  // 40: indykite.config.v1beta1.EventSinkConfig.ProvidersEntry
	(*EventSinkConfig_Route_KeyValuePair)(nil),           // 41: indykite.config.v1beta1.EventSinkConfig.Route.KeyValuePair
	(*EventSinkConfig_Route_EventTypeKeysValues)(nil),    // 42: indykite.config.v1beta1.EventSinkConfig.Route.EventTypeKeysValues
	(*TokenIntrospectConfig_JWT)(nil),                    // 43: indykite.config.v1beta1.TokenIntrospectConfig.JWT
	(*TokenIntrospectConfig_Opaque)(nil),                 // 44: indykite.config.v1beta1.TokenIntrospectConfig.Opaque
	(*TokenIntrospectConfig_Offline)(nil),                // 45: indykite.config.v1beta1.TokenIntrospectConfig.Offline
	(*TokenIntrospectConfig_Online)(nil),                 // 46: indykite.config.v1beta1.TokenIntrospectConfig.Online
	(*TokenIntrospectConfig_Claim)(nil),                  // 47: indykite.config.v1beta1.TokenIntrospectConfig.Claim
	nil,                                                  // 48: indykite.config.v1beta1.TokenIntrospectConfig.ClaimsMappingEntry
	(*ConsentDataPoint_Return)(nil),                      // 49: indykite.config.v1beta1.ConsentDataPoint.Return
	(*EntityMatchingPipelineConfig_NodeFilter)(nil),      // 50: indykite.config.v1beta1.EntityMatchingPipelineConfig.NodeFilter
	(*EntityMatchingPipelineConfig_PropertyMapping)(nil), // 51: indykite.config.v1beta1.EntityMatchingPipelineConfig.PropertyMapping
	(*ExternalDataResolverConfig_Header)(nil),            // 52: indykite.config.v1beta1.ExternalDataResolverConfig.Header
	nil, // 53: indykite.config.v1beta1.ExternalDataResolverConfig.HeadersEntry
	(*TrustScoreProfileConfig_ExecutionTimeWindow)(nil), // 54: indykite.config.v1beta1.TrustScoreProfileConfig.ExecutionTimeWindow
	nil, // 55: indykite.config.v1beta1.TrustScoreProfileConfig.DimensionsExecutionTimesEntry
	(*RegisterCapturePipelineTopicConfig_Script)(nil), // 56: indykite.config.v1beta1.RegisterCapturePipelineTopicConfig.Script
	(*wrapperspb.StringValue)(nil),                    // 57: google.protobuf.StringValue
	(*timestamppb.Timestamp)(nil),                     // 58: google.protobuf.Timestamp
	(*PolicyBuilderConfig)(nil),                       // 59: indykite.config.v1beta1.PolicyBuilderConfig
	(*durationpb.Duration)(nil),                       // 60: google.protobuf.Duration
}
var file_indykite_config_v1beta1_model_proto_depIdxs = []int32{
	57,  // 0: indykite.config.v1beta1.Customer.description:type_name -> google.protobuf.StringValue
	58,  // 1: indykite.config.v1beta1.Customer.create_time:type_name -> google.protobuf.Timestamp
	58,  // 2: indykite.config.v1beta1.Customer.update_time:type_name -> google.protobuf.Timestamp
	58,  // 3: indykite.config.v1beta1.Customer.destroy_time:type_name -> google.protobuf.Timestamp
	58,  // 4: indykite.config.v1beta1.Customer.delete_time:type_name -> google.protobuf.Timestamp
	57,  // 5: indykite.config.v1beta1.ApplicationSpace.description:type_name -> google.protobuf.StringValue
	58,  // 6: indykite.config.v1beta1.ApplicationSpace.create_time:type_name -> google.protobuf.Timestamp
	58,  // 7: indykite.config.v1beta1.ApplicationSpace.update_time:type_name -> google.protobuf.Timestamp
	58,  // 8: indykite.config.v1beta1.ApplicationSpace.destroy_time:type_name -> google.protobuf.Timestamp
	58,  // 9: indykite.config.v1beta1.ApplicationSpace.delete_time:type_name -> google.protobuf.Timestamp
	0,   // 10: indykite.config.v1beta1.ApplicationSpace.ikg_status:type_name -> indykite.config.v1beta1.AppSpaceIKGStatus
	11,  // 11: indykite.config.v1beta1.ApplicationSpace.db_connection:type_name -> indykite.config.v1beta1.DBConnection
	57,  // 12: indykite.config.v1beta1.Application.description:type_name -> google.protobuf.StringValue
	58,  // 13: indykite.config.v1beta1.Application.create_time:type_name -> google.protobuf.Timestamp
	58,  // 14: indykite.config.v1beta1.Application.update_time:type_name -> google.protobuf.Timestamp
	58,  // 15: indykite.config.v1beta1.Application.destroy_time:type_name -> google.protobuf.Timestamp
	58,  // 16: indykite.config.v1beta1.Application.delete_time:type_name -> google.protobuf.Timestamp
	57,  // 17: indykite.config.v1beta1.ApplicationAgent.description:type_name -> google.protobuf.StringValue
	58,  // 18: indykite.config.v1beta1.ApplicationAgent.create_time:type_name -> google.protobuf.Timestamp
	58,  // 19: indykite.config.v1beta1.ApplicationAgent.update_time:type_name -> google.protobuf.Timestamp
	58,  // 20: indykite.config.v1beta1.ApplicationAgent.destroy_time:type_name -> google.protobuf.Timestamp
	58,  // 21: indykite.config.v1beta1.ApplicationAgent.delete_time:type_name -> google.protobuf.Timestamp
	58,  // 22: indykite.config.v1beta1.ApplicationAgentCredential.create_time:type_name -> google.protobuf.Timestamp
	58,  // 23: indykite.config.v1beta1.ApplicationAgentCredential.destroy_time:type_name -> google.protobuf.Timestamp
	58,  // 24: indykite.config.v1beta1.ApplicationAgentCredential.delete_time:type_name -> google.protobuf.Timestamp
	58,  // 25: indykite.config.v1beta1.ApplicationAgentCredential.expire_time:type_name -> google.protobuf.Timestamp
	57,  // 26: indykite.config.v1beta1.ServiceAccount.description:type_name -> google.protobuf.StringValue
	58,  // 27: indykite.config.v1beta1.ServiceAccount.create_time:type_name -> google.protobuf.Timestamp
	58,  // 28: indykite.config.v1beta1.ServiceAccount.update_time:type_name -> google.protobuf.Timestamp
	58,  // 29: indykite.config.v1beta1.ServiceAccount.destroy_time:type_name -> google.protobuf.Timestamp
	58,  // 30: indykite.config.v1beta1.ServiceAccount.delete_time:type_name -> google.protobuf.Timestamp
	58,  // 31: indykite.config.v1beta1.ServiceAccountCredential.create_time:type_name -> google.protobuf.Timestamp
	58,  // 32: indykite.config.v1beta1.ServiceAccountCredential.destroy_time:type_name -> google.protobuf.Timestamp
	58,  // 33: indykite.config.v1beta1.ServiceAccountCredential.delete_time:type_name -> google.protobuf.Timestamp
	58,  // 34: indykite.config.v1beta1.ServiceAccountCredential.expire_time:type_name -> google.protobuf.Timestamp
	57,  // 35: indykite.config.v1beta1.ConfigNode.description:type_name -> google.protobuf.StringValue
	58,  // 36: indykite.config.v1beta1.ConfigNode.create_time:type_name -> google.protobuf.Timestamp
	58,  // 37: indykite.config.v1beta1.ConfigNode.update_time:type_name -> google.protobuf.Timestamp
	58,  // 38: indykite.config.v1beta1.ConfigNode.destroy_time:type_name -> google.protobuf.Timestamp
	58,  // 39: indykite.config.v1beta1.ConfigNode.delete_time:type_name -> google.protobuf.Timestamp
	20,  // 40: indykite.config.v1beta1.ConfigNode.event_sink_config:type_name -> indykite.config.v1beta1.EventSinkConfig
	19,  // 41: indykite.config.v1beta1.ConfigNode.authorization_policy_config:type_name -> indykite.config.v1beta1.AuthorizationPolicyConfig
	24,  // 42: indykite.config.v1beta1.ConfigNode.consent_config:type_name -> indykite.config.v1beta1.ConsentConfiguration
	25,  // 43: indykite.config.v1beta1.ConfigNode.token_introspect_config:type_name -> indykite.config.v1beta1.TokenIntrospectConfig
	27,  // 44: indykite.config.v1beta1.ConfigNode.ingest_pipeline_config:type_name -> indykite.config.v1beta1.IngestPipelineConfig
	28,  // 45: indykite.config.v1beta1.ConfigNode.entity_matching_pipeline_config:type_name -> indykite.config.v1beta1.EntityMatchingPipelineConfig
	29,  // 46: indykite.config.v1beta1.ConfigNode.external_data_resolver_config:type_name -> indykite.config.v1beta1.ExternalDataResolverConfig
	31,  // 47: indykite.config.v1beta1.ConfigNode.trust_score_profile_config:type_name -> indykite.config.v1beta1.TrustScoreProfileConfig
	32,  // 48: indykite.config.v1beta1.ConfigNode.knowledge_query_config:type_name -> indykite.config.v1beta1.KnowledgeQueryConfig
	34,  // 49: indykite.config.v1beta1.ConfigNode.capture_pipeline_config:type_name -> indykite.config.v1beta1.CapturePipelineConfig
	36,  // 50: indykite.config.v1beta1.ConfigNode.capture_pipeline_topic_config:type_name -> indykite.config.v1beta1.CapturePipelineTopicConfig
	3,   // 51: indykite.config.v1beta1.AuthorizationPolicyConfig.status:type_name -> indykite.config.v1beta1.AuthorizationPolicyConfig.Status
	59,  // 52: indykite.config.v1beta1.AuthorizationPolicyConfig.builder:type_name -> indykite.config.v1beta1.PolicyBuilderConfig
	40,  // 53: indykite.config.v1beta1.EventSinkConfig.providers:type_name -> indykite.config.v1beta1.EventSinkConfig.ProvidersEntry
	39,  // 54: indykite.config.v1beta1.EventSinkConfig.routes:type_name -> indykite.config.v1beta1.EventSinkConfig.Route
	57,  // 55: indykite.config.v1beta1.KafkaSinkConfig.display_name:type_name -> google.protobuf.StringValue
	57,  // 56: indykite.config.v1beta1.AzureEventGridSinkConfig.display_name:type_name -> google.protobuf.StringValue
	57,  // 57: indykite.config.v1beta1.AzureServiceBusSinkConfig.display_name:type_name -> google.protobuf.StringValue
	1,   // 58: indykite.config.v1beta1.ConsentConfiguration.token_status:type_name -> indykite.config.v1beta1.ExternalTokenStatus
	43,  // 59: indykite.config.v1beta1.TokenIntrospectConfig.jwt:type_name -> indykite.config.v1beta1.TokenIntrospectConfig.JWT
	44,  // 60: indykite.config.v1beta1.TokenIntrospectConfig.opaque:type_name -> indykite.config.v1beta1.TokenIntrospectConfig.Opaque
	45,  // 61: indykite.config.v1beta1.TokenIntrospectConfig.offline:type_name -> indykite.config.v1beta1.TokenIntrospectConfig.Offline
	46,  // 62: indykite.config.v1beta1.TokenIntrospectConfig.online:type_name -> indykite.config.v1beta1.TokenIntrospectConfig.Online
	48,  // 63: indykite.config.v1beta1.TokenIntrospectConfig.claims_mapping:type_name -> indykite.config.v1beta1.TokenIntrospectConfig.ClaimsMappingEntry
	47,  // 64: indykite.config.v1beta1.TokenIntrospectConfig.sub_claim:type_name -> indykite.config.v1beta1.TokenIntrospectConfig.Claim
	49,  // 65: indykite.config.v1beta1.ConsentDataPoint.returns:type_name -> indykite.config.v1beta1.ConsentDataPoint.Return
	2,   // 66: indykite.config.v1beta1.IngestPipelineConfig.operations:type_name -> indykite.config.v1beta1.IngestPipelineOperation
	50,  // 67: indykite.config.v1beta1.EntityMatchingPipelineConfig.node_filter:type_name -> indykite.config.v1beta1.EntityMatchingPipelineConfig.NodeFilter
	4,   // 68: indykite.config.v1beta1.EntityMatchingPipelineConfig.property_mapping_status:type_name -> indykite.config.v1beta1.EntityMatchingPipelineConfig.Status
	57,  // 69: indykite.config.v1beta1.EntityMatchingPipelineConfig.property_mapping_message:type_name -> google.protobuf.StringValue
	4,   // 70: indykite.config.v1beta1.EntityMatchingPipelineConfig.entity_matching_status:type_name -> indykite.config.v1beta1.EntityMatchingPipelineConfig.Status
	57,  // 71: indykite.config.v1beta1.EntityMatchingPipelineConfig.entity_matching_message:type_name -> google.protobuf.StringValue
	51,  // 72: indykite.config.v1beta1.EntityMatchingPipelineConfig.property_mappings:type_name -> indykite.config.v1beta1.EntityMatchingPipelineConfig.PropertyMapping
	58,  // 73: indykite.config.v1beta1.EntityMatchingPipelineConfig.last_run_time:type_name -> google.protobuf.Timestamp
	57,  // 74: indykite.config.v1beta1.EntityMatchingPipelineConfig.report_url:type_name -> google.protobuf.StringValue
	57,  // 75: indykite.config.v1beta1.EntityMatchingPipelineConfig.report_type:type_name -> google.protobuf.StringValue
	53,  // 76: indykite.config.v1beta1.ExternalDataResolverConfig.headers:type_name -> indykite.config.v1beta1.ExternalDataResolverConfig.HeadersEntry
	5,   // 77: indykite.config.v1beta1.ExternalDataResolverConfig.request_type:type_name -> indykite.config.v1beta1.ExternalDataResolverConfig.ContentType
	5,   // 78: indykite.config.v1beta1.ExternalDataResolverConfig.response_type:type_name -> indykite.config.v1beta1.ExternalDataResolverConfig.ContentType
	6,   // 79: indykite.config.v1beta1.TrustScoreDimension.name:type_name -> indykite.config.v1beta1.TrustScoreDimension.Name
	30,  // 80: indykite.config.v1beta1.TrustScoreProfileConfig.dimensions:type_name -> indykite.config.v1beta1.TrustScoreDimension
	7,   // 81: indykite.config.v1beta1.TrustScoreProfileConfig.schedule:type_name -> indykite.config.v1beta1.TrustScoreProfileConfig.UpdateFrequency
	57,  // 82: indykite.config.v1beta1.TrustScoreProfileConfig.last_run_id:type_name -> google.protobuf.StringValue
	58,  // 83: indykite.config.v1beta1.TrustScoreProfileConfig.last_run_start_time:type_name -> google.protobuf.Timestamp
	58,  // 84: indykite.config.v1beta1.TrustScoreProfileConfig.last_run_end_time:type_name -> google.protobuf.Timestamp
	55,  // 85: indykite.config.v1beta1.TrustScoreProfileConfig.dimensions_execution_times:type_name -> indykite.config.v1beta1.TrustScoreProfileConfig.DimensionsExecutionTimesEntry
	8,   // 86: indykite.config.v1beta1.KnowledgeQueryConfig.status:type_name -> indykite.config.v1beta1.KnowledgeQueryConfig.Status
	56,  // 87: indykite.config.v1beta1.RegisterCapturePipelineTopicConfig.script:type_name -> indykite.config.v1beta1.RegisterCapturePipelineTopicConfig.Script
	37,  // 88: indykite.config.v1beta1.CapturePipelineTopicConfig.script:type_name -> indykite.config.v1beta1.CapturePipelineTopicScriptConfig
	21,  // 89: indykite.config.v1beta1.EventSinkConfig.Provider.kafka:type_name -> indykite.config.v1beta1.KafkaSinkConfig
	22,  // 90: indykite.config.v1beta1.EventSinkConfig.Provider.azure_event_grid:type_name -> indykite.config.v1beta1.AzureEventGridSinkConfig
	23,  // 91: indykite.config.v1beta1.EventSinkConfig.Provider.azure_service_bus:type_name -> indykite.config.v1beta1.AzureServiceBusSinkConfig
	42,  // 92: indykite.config.v1beta1.EventSinkConfig.Route.keys_values:type_name -> indykite.config.v1beta1.EventSinkConfig.Route.EventTypeKeysValues
	57,  // 93: indykite.config.v1beta1.EventSinkConfig.Route.display_name:type_name -> google.protobuf.StringValue
	57,  // 94: indykite.config.v1beta1.EventSinkConfig.Route.id:type_name -> google.protobuf.StringValue
	38,  // 95: indykite.config.v1beta1.EventSinkConfig.ProvidersEntry.value:type_name -> indykite.config.v1beta1.EventSinkConfig.Provider
	41,  // 96: indykite.config.v1beta1.EventSinkConfig.Route.EventTypeKeysValues.key_value_pairs:type_name -> indykite.config.v1beta1.EventSinkConfig.Route.KeyValuePair
	60,  // 97: indykite.config.v1beta1.TokenIntrospectConfig.Online.cache_ttl:type_name -> google.protobuf.Duration
	47,  // 98: indykite.config.v1beta1.TokenIntrospectConfig.ClaimsMappingEntry.value:type_name -> indykite.config.v1beta1.TokenIntrospectConfig.Claim
	52,  // 99: indykite.config.v1beta1.ExternalDataResolverConfig.HeadersEntry.value:type_name -> indykite.config.v1beta1.ExternalDataResolverConfig.Header
	58,  // 100: indykite.config.v1beta1.TrustScoreProfileConfig.ExecutionTimeWindow.start_time:type_name -> google.protobuf.Timestamp
	58,  // 101: indykite.config.v1beta1.TrustScoreProfileConfig.ExecutionTimeWindow.end_time:type_name -> google.protobuf.Timestamp
	54,  // 102: indykite.config.v1beta1.TrustScoreProfileConfig.DimensionsExecutionTimesEntry.value:type_name -> indykite.config.v1beta1.TrustScoreProfileConfig.ExecutionTimeWindow
...
func file_indykite_config_v1beta1_model_proto_init() {
	...
	file_indykite_config_v1beta1_model_proto_msgTypes[16].OneofWrappers = []any{
