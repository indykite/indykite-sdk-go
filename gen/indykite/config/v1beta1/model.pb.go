...
func (AuthorizationPolicyConfig_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_indykite_config_v1beta1_model_proto_enumTypes[12].Descriptor()
}

func (AuthorizationPolicyConfig_Status) Type() protoreflect.EnumType {
	return &file_indykite_config_v1beta1_model_proto_enumTypes[12]
}
...
func (AuthorizationPolicyConfig_Status) EnumDescriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{37, 0}
}
...
type ApplicationSpaceConfig struct {
	...
	//
	// To unset any flow from being default send an empty value.
	DefaultEmailServiceId string `protobuf:"bytes,4,opt,name=default_email_service_id,json=defaultEmailServiceId,proto3" json:"default_email_service_id,omitempty"`
	...
	UniquePropertyConstraints map[string]*UniquePropertyConstraint `protobuf:"bytes,5,rep,name=unique_property_constraints,json=uniquePropertyConstraints,proto3" json:"unique_property_constraints,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *ApplicationSpaceConfig) GetUniquePropertyConstraints() map[string]*UniquePropertyConstraint {
	if x != nil {
		return x.UniquePropertyConstraints
	}
	return nil
}
...
type ConfigNode struct {
	...
	//	*ConfigNode_TokenExchangeConfig
...
func (x *ConfigNode) GetTokenExchangeConfig() *TokenExchangeConfig {
	if x, ok := x.GetConfig().(*ConfigNode_TokenExchangeConfig); ok {
...
type ConfigNode_TokenExchangeConfig struct {
	TokenExchangeConfig *TokenExchangeConfig `protobuf:"bytes,31,opt,name=token_exchange_config,json=tokenExchangeConfig,proto3,oneof"`
}
...
func (*ConfigNode_TokenExchangeConfig) isConfigNode_Config() {}
...
type UsernamePolicy struct {
	...
	AllowedUsernameFormats []string `protobuf:"bytes,5,rep,name=allowed_username_formats,json=allowedUsernameFormats,proto3" json:"allowed_username_formats,omitempty"`
	...
	VerifyEmailGracePeriod *durationpb.Duration `protobuf:"bytes,7,opt,name=verify_email_grace_period,json=verifyEmailGracePeriod,proto3" json:"verify_email_grace_period,omitempty"`
...
func (*AuditSinkConfig) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{38}
}
...
func (*KafkaSinkConfig) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{39}
}
...
func (*ConsentConfiguration) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{40}
}
...
type TokenExchangeConfig struct {
	...
	//
	//	*TokenExchangeConfig_Jwt
	TokenMatcher isTokenExchangeConfig_TokenMatcher `protobuf_oneof:"token_matcher"`
	// Types that are assignable to Validation:
	//
	//	*TokenExchangeConfig_Offline_
	Validation isTokenExchangeConfig_Validation `protobuf_oneof:"validation"`
	...
	ClaimsMapping map[string]*TokenExchangeConfig_Claim `protobuf:"bytes,7,rep,name=claims_mapping,json=claimsMapping,proto3" json:"claims_mapping,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (*TokenExchangeConfig) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{41}
}

func (m *TokenExchangeConfig) GetTokenMatcher() isTokenExchangeConfig_TokenMatcher {
	if m != nil {
...
func (x *TokenExchangeConfig) GetJwt() *TokenExchangeConfig_JWT {
	if x, ok := x.GetTokenMatcher().(*TokenExchangeConfig_Jwt); ok {
		return x.Jwt
	}
	return nil
}

func (m *TokenExchangeConfig) GetValidation() isTokenExchangeConfig_Validation {
	if m != nil {
		return m.Validation
	}
	return nil
...
func (x *TokenExchangeConfig) GetOffline() *TokenExchangeConfig_Offline {
	if x, ok := x.GetValidation().(*TokenExchangeConfig_Offline_); ok {
		return x.Offline
	}
	return nil
}

func (x *TokenExchangeConfig) GetClaimsMapping() map[string]*TokenExchangeConfig_Claim {
	if x != nil {
...
func (x *TokenExchangeConfig) GetIkgNodeType() string {
	if x != nil {
...
func (x *TokenExchangeConfig) GetPerformUpsert() bool {
	if x != nil {
...
type isTokenExchangeConfig_TokenMatcher interface {
	isTokenExchangeConfig_TokenMatcher()
}

type TokenExchangeConfig_Jwt struct {
	Jwt *TokenExchangeConfig_JWT `protobuf:"bytes,1,opt,name=jwt,proto3,oneof"`
}

func (*TokenExchangeConfig_Jwt) isTokenExchangeConfig_TokenMatcher() {}

type isTokenExchangeConfig_Validation interface {
	isTokenExchangeConfig_Validation()
}

type TokenExchangeConfig_Offline_ struct {
	Offline *TokenExchangeConfig_Offline `protobuf:"bytes,3,opt,name=offline,proto3,oneof"`
}

func (*TokenExchangeConfig_Offline_) isTokenExchangeConfig_Validation() {}
...
func (x *TokenExchangeConfig_JWT) Reset() {
	*x = TokenExchangeConfig_JWT{}
	if protoimpl.UnsafeEnabled {
...
func (x *TokenExchangeConfig_JWT) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenExchangeConfig_JWT) ProtoMessage() {}

func (x *TokenExchangeConfig_JWT) ProtoReflect() protoreflect.Message {
	mi := &file_indykite_config_v1beta1_model_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenExchangeConfig_JWT.ProtoReflect.Descriptor instead.
func (*TokenExchangeConfig_JWT) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{41, 0}
}

func (x *TokenExchangeConfig_JWT) GetIssuer() string {
	if x != nil {
		return x.Issuer
	}
	return ""
...
func (x *TokenExchangeConfig_JWT) GetAudience() string {
	if x != nil {
		return x.Audience
	}
	return ""
...
type TokenExchangeConfig_Offline struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TokenExchangeConfig_Offline) Reset() {
	*x = TokenExchangeConfig_Offline{}
	if protoimpl.UnsafeEnabled {
		mi := &file_indykite_config_v1beta1_model_proto_msgTypes[54]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TokenExchangeConfig_Offline) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenExchangeConfig_Offline) ProtoMessage() {}

func (x *TokenExchangeConfig_Offline) ProtoReflect() protoreflect.Message {
	mi := &file_indykite_config_v1beta1_model_proto_msgTypes[54]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenExchangeConfig_Offline.ProtoReflect.Descriptor instead.
func (*TokenExchangeConfig_Offline) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{41, 1}
}

func (x *TokenExchangeConfig_Offline) GetPublicJwks() [][]byte {
	if x != nil {
		return x.PublicJwks
	}
	return nil
...
type TokenExchangeConfig_Claim struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TokenExchangeConfig_Claim) Reset() {
	*x = TokenExchangeConfig_Claim{}
	if protoimpl.UnsafeEnabled {
		mi := &file_indykite_config_v1beta1_model_proto_msgTypes[55]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TokenExchangeConfig_Claim) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenExchangeConfig_Claim) ProtoMessage() {}

func (x *TokenExchangeConfig_Claim) ProtoReflect() protoreflect.Message {
	mi := &file_indykite_config_v1beta1_model_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenExchangeConfig_Claim.ProtoReflect.Descriptor instead.
func (*TokenExchangeConfig_Claim) Descriptor() ([]byte, []int) {
	return file_indykite_config_v1beta1_model_proto_rawDescGZIP(), []int{41, 2}
}

func (x *TokenExchangeConfig_Claim) GetSelector() string {
	if x != nil {
		return x.Selector
	}
	return ""
...
var file_indykite_config_v1beta1_model_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x35, 0x34, 0x7d, 0x24, 0x52, 0x08, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72, 0x49, 0x64, 0x12, 0x49,
	0x0a, 0x0a, 0x69, 0x6b, 0x67, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0e, 0x20, 0x01,
	...
	0x53, 0x70, 0x61, 0x63, 0x65, 0x49, 0x4b, 0x47, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x09,
	0x69, 0x6b, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xce, 0x05, 0x0a, 0x16, 0x41, 0x70,
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x70, 0x61, 0x63, 0x65, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x53, 0x0a, 0x11, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f,
	...
	0x32, 0x35, 0x34, 0x7d, 0x24, 0xd0, 0x01, 0x01, 0x52, 0x0f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c,
	0x74, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x58, 0x0a, 0x14, 0x64, 0x65, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x69,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x27, 0xfa, 0x42, 0x24, 0x72, 0x22, 0x10, 0x16,
	...
	,
	...
	,
	...
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x55, 0x6e, 0x69, 0x71, 0x75, 0x65, 0x50, 0x72, 0x6f,
	0x70, 0x65, 0x72, 0x74, 0x79, 0x43, 0x6f, 0x6e, 0x73, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x74, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb0, 0x06, 0x0a, 0x06, 0x54,
	...
	,
	...
	0x05, 0x8a, 0x01, 0x02, 0x10, 0x00, 0x52, 0x0e, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22, 0xd8, 0x05, 0x0a, 0x0b, 0x41, 0x70, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x34, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	0x42, 0x79, 0x12, 0x3d, 0x0a, 0x0c, 0x64, 0x65, 0x73, 0x74, 0x72, 0x6f, 0x79, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73,
	0x74, 0x61, 0x6d, 0x70, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x74, 0x72, 0x6f, 0x79, 0x54, 0x69, 0x6d,
	...
	0x61, 0x67, 0x12, 0x45, 0x0a, 0x0b, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x5f, 0x69,
	...
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x49, 0x64, 0x12, 0x46, 0x0a, 0x0c, 0x61, 0x70, 0x70,
	...
	0x64, 0x22, 0xe0, 0x06, 0x0a, 0x10, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x34, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x24, 0xfa, 0x42, 0x21, 0x72, 0x1f, 0x10, 0x16, 0x18, 0xfe, 0x01, 0x32, 0x18,
	0x5e, 0x5b, 0x41, 0x2d, 0x5a, 0x61, 0x2d, 0x7a, 0x30, 0x2d, 0x39, 0x2d, 0x5f, 0x3a, 0x5d, 0x7b,
	0x32, 0x32, 0x2c, 0x32, 0x35, 0x34, 0x7d, 0x24, 0x52, 0x02, 0x69, 0x64, 0x12, 0x41, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2d, 0xfa, 0x42, 0x2a, 0x72,
	...
	,
	...
	0x64, 0x42, 0x79, 0x12, 0x3d, 0x0a, 0x0c, 0x64, 0x65, 0x73, 0x74, 0x72, 0x6f, 0x79, 0x5f, 0x74,
	0x69, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x74, 0x72, 0x6f, 0x79, 0x54, 0x69,
	...
	,
	...
	0x63, 0x65, 0x49, 0x64, 0x22, 0xec, 0x04, 0x0a, 0x18, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61,
	0x6c, 0x12, 0x34, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x24, 0xfa,
	...
	0x34, 0x7d, 0x24, 0x52, 0x02, 0x69, 0x64, 0x12, 0x2d, 0x0a, 0x03, 0x6b, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x1b, 0xfa, 0x42, 0x18, 0x72, 0x16, 0x10, 0x29, 0x18, 0x2d, 0x32,
	0x10, 0x5e, 0x5b, 0x61, 0x2d, 0x7a, 0x41, 0x2d, 0x5a, 0x30, 0x2d, 0x39, 0x2d, 0x5f, 0x5d, 0x2b,
	0x24, 0x52, 0x03, 0x6b, 0x69, 0x64, 0x12, 0x2d, 0x0a, 0x0c, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61,
	...
	0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	0x70, 0x52, 0x0a, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x45, 0x0a,
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x49, 0x0a, 0x0c, 0x61, 0x70, 0x70, 0x5f, 0x73, 0x70, 0x61, 0x63,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x42, 0x27, 0xfa, 0x42, 0x24, 0x72,
	0x22, 0x10, 0x16, 0x18, 0xfe, 0x01, 0x32, 0x18, 0x5e, 0x5b, 0x41, 0x2d, 0x5a, 0x61, 0x2d, 0x7a,
	0x30, 0x2d, 0x39, 0x2d, 0x5f, 0x3a, 0x5d, 0x7b, 0x32, 0x32, 0x2c, 0x32, 0x35, 0x34, 0x7d, 0x24,
	0xd0, 0x01, 0x01, 0x52, 0x0a, 0x61, 0x70, 0x70, 0x53, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12,
	0x52, 0x0a, 0x12, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x42, 0x24, 0xfa, 0x42, 0x21,
	...
	0x24, 0x52, 0x10, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x49, 0x64, 0x22, 0x95, 0x0f, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4e, 0x6f,
	0x64, 0x65, 0x12, 0x34, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x24,
	0xfa, 0x42, 0x21, 0x72, 0x1f, 0x10, 0x16, 0x18, 0xfe, 0x01, 0x32, 0x18, 0x5e, 0x5b, 0x41, 0x2d,
	0x5a, 0x61, 0x2d, 0x7a, 0x30, 0x2d, 0x39, 0x2d, 0x5f, 0x3a, 0x5d, 0x7b, 0x32, 0x32, 0x2c, 0x32,
	...
	0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x18, 0x1a,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x42, 0x79, 0x12,
	0x1d, 0x0a, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x18, 0x1b, 0x20,
	...
	0x72, 0x1f, 0x10, 0x16, 0x18, 0xfe, 0x01, 0x32, 0x18, 0x5e, 0x5b, 0x41, 0x2d, 0x5a, 0x61, 0x2d,
	0x7a, 0x30, 0x2d, 0x39, 0x2d, 0x5f, 0x3a, 0x5d, 0x7b, 0x32, 0x32, 0x2c, 0x32, 0x35, 0x34, 0x7d,
	0x24, 0x52, 0x0a, 0x61, 0x70, 0x70, 0x53, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x41, 0x0a,
	...
	0x2c, 0x32, 0x35, 0x34, 0x7d, 0x24, 0x52, 0x08, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x49, 0x64,
	0x12, 0x5d, 0x0a, 0x10, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x69, 0x6e, 0x64,
	...
	0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x48, 0x00, 0x52, 0x0d, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x12, 0x6c, 0x0a, 0x15, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x65, 0x78, 0x63, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x1f, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x2c, 0x2e, 0x69, 0x6e, 0x64, 0x79, 0x6b, 0x69, 0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42,
	0x08, 0xfa, 0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x48, 0x00, 0x52, 0x13, 0x74, 0x6f, 0x6b,
	...
	,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x42, 0x79, 0x12, 0x3d, 0x0a, 0x0c, 0x64, 0x65, 0x73, 0x74,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xd8, 0x0b, 0x0a, 0x17, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x32,
	...
	0x6e, 0x73, 0x65, 0x41, 0x6c, 0x67, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x72, 0x75, 0x73, 0x74, 0x65,
	0x64, 0x18, 0x17, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x74, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64,
	0x22, 0xa2, 0x06, 0x0a, 0x0e, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x32, 0x50, 0x72, 0x6f, 0x76, 0x69,
	0x64, 0x65, 0x72, 0x12, 0x34, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x24, 0xfa, 0x42, 0x21, 0x72, 0x1f, 0x10, 0x16, 0x18, 0xfe, 0x01, 0x32, 0x18, 0x5e, 0x5b, 0x41,
	0x2d, 0x5a, 0x61, 0x2d, 0x7a, 0x30, 0x2d, 0x39, 0x2d, 0x5f, 0x3a, 0x5d, 0x7b, 0x32, 0x32, 0x2c,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa8, 0x06, 0x0a, 0x16, 0x57, 0x65, 0x62,
	0x41, 0x75, 0x74, 0x68, 0x6e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x12, 0x86, 0x01, 0x0a, 0x0f, 0x72, 0x65, 0x6c, 0x79, 0x69, 0x6e, 0x67, 0x5f,
	0x70, 0x61, 0x72, 0x74, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e,
	0x69, 0x6e, 0x64, 0x79, 0x6b, 0x69, 0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e,
	...
	,
	...
	,
	...
	0xaa, 0x01, 0x07, 0x22, 0x03, 0x08, 0x84, 0x07, 0x32, 0x00, 0x52, 0x13, 0x72, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12,
	0x5f, 0x0a, 0x16, 0x61, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x69, 0x6c, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x14, 0x72,
	0x65, 0x73, 0x65, 0x74, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x12, 0x5b, 0x0a, 0x14, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74,
	...
	,
	...
	,
	...
	0x73, 0x73, 0x22, 0xd5, 0x03, 0x0a, 0x17, 0x41, 0x6d, 0x61, 0x7a, 0x6f, 0x6e, 0x53, 0x45, 0x53,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0a, 0xfa, 0x42, 0x07, 0x72, 0x05, 0x10, 0x19, 0x18, 0xfe,
	...
	,
	...
	0x10, 0x01, 0x48, 0x00, 0x52, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x4b,
	...
	,
	...
	,
	...
	,
	...
	0x54, 0x79, 0x70, 0x65, 0x12, 0x3b, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f,
	...
	0x64, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x06, 0x69, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x66, 0x69, 0x6c,
	...
	0x22, 0xb3, 0x08, 0x0a, 0x0c, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x12, 0x32, 0x0a, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x69, 0x6e, 0x64, 0x79, 0x6b, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x10, 0x0a, 0x0c, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x44, 0x52, 0x41, 0x46, 0x54,
	0x10, 0x03, 0x22, 0x6e, 0x0a, 0x0f, 0x41, 0x75, 0x64, 0x69, 0x74, 0x53, 0x69, 0x6e, 0x6b, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x4a, 0x0a, 0x05, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x18, 0x01,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x02, 0x12, 0x26, 0x0a, 0x22, 0x41, 0x50, 0x50, 0x5f, 0x53,
	...
	,
	...
	0x42, 0x41, 0x53, 0x49, 0x43, 0x10, 0x01, 0x12, 0x31, 0x0a, 0x2d, 0x54, 0x4f, 0x4b, 0x45, 0x4e,
	0x5f, 0x45, 0x4e, 0x44, 0x50, 0x4f, 0x49, 0x4e, 0x54, 0x5f, 0x41, 0x55, 0x54, 0x48, 0x5f, 0x4d,
	0x45, 0x54, 0x48, 0x4f, 0x44, 0x5f, 0x43, 0x4c, 0x49, 0x45, 0x4e, 0x54, 0x5f, 0x53, 0x45, 0x43,
	0x52, 0x45, 0x54, 0x5f, 0x50, 0x4f, 0x53, 0x54, 0x10, 0x02, 0x12, 0x2e, 0x0a, 0x2a, 0x54, 0x4f,
	...
	,
	...
	0x25, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x56, 0x45, 0x52, 0x49, 0x46, 0x49, 0x43, 0x41, 0x54, 0x49,
	0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x51, 0x55, 0x49, 0x52, 0x45, 0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x49,
	0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x00, 0x12, 0x2b, 0x0a, 0x27, 0x55, 0x53, 0x45, 0x52,
	0x5f, 0x56, 0x45, 0x52, 0x49, 0x46, 0x49, 0x43, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x45,
	0x51, 0x55, 0x49, 0x52, 0x45, 0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x50, 0x52, 0x45, 0x46, 0x45, 0x52,
	0x52, 0x45, 0x44, 0x10, 0x01, 0x12, 0x2a, 0x0a, 0x26, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x56, 0x45,
	...
	,
...
var file_indykite_config_v1beta1_model_proto_enumTypes = make([]protoimpl.EnumInfo, 13)
var file_indykite_config_v1beta1_model_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_indykite_config_v1beta1_model_proto_goTypes = []interface{}{
	...
	(PasswordPolicyTemplate)(0),           // 10: indykite.config.v1beta1.PasswordPolicyTemplate
	(AuthFlowConfig_Format)(0),            // 11: indykite.config.v1beta1.AuthFlowConfig.Format
	(AuthorizationPolicyConfig_Status)(0), // 12: indykite.config.v1beta1.AuthorizationPolicyConfig.Status
	(*UniqueNameIdentifier)(nil),          // 13: indykite.config.v1beta1.UniqueNameIdentifier
	(*Customer)(nil),                      // 14: indykite.config.v1beta1.Customer
	(*CustomerConfig)(nil),                // 15: indykite.config.v1beta1.CustomerConfig
	(*ApplicationSpace)(nil),              // 16: indykite.config.v1beta1.ApplicationSpace
	(*ApplicationSpaceConfig)(nil),        // 17: indykite.config.v1beta1.ApplicationSpaceConfig
	(*Tenant)(nil),                        // 18: indykite.config.v1beta1.Tenant
	(*TenantConfig)(nil),                  // 19: indykite.config.v1beta1.TenantConfig
	(*Application)(nil),                   // 20: indykite.config.v1beta1.Application
	(*ApplicationAgent)(nil),              // 21: indykite.config.v1beta1.ApplicationAgent
	(*ApplicationAgentCredential)(nil),    // 22: indykite.config.v1beta1.ApplicationAgentCredential
	(*ServiceAccount)(nil),                // 23: indykite.config.v1beta1.ServiceAccount
	(*ServiceAccountCredential)(nil),      // 24: indykite.config.v1beta1.ServiceAccountCredential
	(*ConfigNode)(nil),                    // 25: indykite.config.v1beta1.ConfigNode
	(*OAuth2ClientConfig)(nil),            // 26: indykite.config.v1beta1.OAuth2ClientConfig
	(*OAuth2Application)(nil),             // 27: indykite.config.v1beta1.OAuth2Application
	(*OAuth2ApplicationConfig)(nil),       // 28: indykite.config.v1beta1.OAuth2ApplicationConfig
	(*OAuth2Provider)(nil),                // 29: indykite.config.v1beta1.OAuth2Provider
	(*OAuth2ProviderConfig)(nil),          // 30: indykite.config.v1beta1.OAuth2ProviderConfig
	(*WebAuthnProviderConfig)(nil),        // 31: indykite.config.v1beta1.WebAuthnProviderConfig
	(*WebAuthnSiteDefinition)(nil),        // 32: indykite.config.v1beta1.WebAuthnSiteDefinition
	(*AuthFlowConfig)(nil),                // 33: indykite.config.v1beta1.AuthFlowConfig
	(*SAFRProviderConfig)(nil),            // 34: indykite.config.v1beta1.SAFRProviderConfig
	(*SMSServiceConfig)(nil),              // 35: indykite.config.v1beta1.SMSServiceConfig
	(*EmailServiceConfig)(nil),            // 36: indykite.config.v1beta1.EmailServiceConfig
	(*Email)(nil),                         // 37: indykite.config.v1beta1.Email
	(*SendGridProviderConfig)(nil),        // 38: indykite.config.v1beta1.SendGridProviderConfig
	(*MailJetProviderConfig)(nil),         // 39: indykite.config.v1beta1.MailJetProviderConfig
	(*MailgunProviderConfig)(nil),         // 40: indykite.config.v1beta1.MailgunProviderConfig
	(*AmazonSESProviderConfig)(nil),       // 41: indykite.config.v1beta1.AmazonSESProviderConfig
	(*EmailDefinition)(nil),               // 42: indykite.config.v1beta1.EmailDefinition
	(*EmailTemplate)(nil),                 // 43: indykite.config.v1beta1.EmailTemplate
	(*EmailAttachment)(nil),               // 44: indykite.config.v1beta1.EmailAttachment
	(*EmailMessage)(nil),                  // 45: indykite.config.v1beta1.EmailMessage
	(*PasswordProviderConfig)(nil),        // 46: indykite.config.v1beta1.PasswordProviderConfig
	(*UsernamePolicy)(nil),                // 47: indykite.config.v1beta1.UsernamePolicy
	(*UniquePropertyConstraint)(nil),      // 48: indykite.config.v1beta1.UniquePropertyConstraint
	(*PasswordPolicy)(nil),                // 49: indykite.config.v1beta1.PasswordPolicy
	(*AuthorizationPolicyConfig)(nil),     // 50: indykite.config.v1beta1.AuthorizationPolicyConfig
	(*AuditSinkConfig)(nil),               // 51: indykite.config.v1beta1.AuditSinkConfig
	(*KafkaSinkConfig)(nil),               // 52: indykite.config.v1beta1.KafkaSinkConfig
	(*ConsentConfiguration)(nil),          // 53: indykite.config.v1beta1.ConsentConfiguration
	(*TokenExchangeConfig)(nil),           // 54: indykite.config.v1beta1.TokenExchangeConfig
	nil,                                   // 55: indykite.config.v1beta1.ApplicationSpaceConfig.UniquePropertyConstraintsEntry
	nil,                                   // 56: indykite.config.v1beta1.OAuth2ProviderConfig.FrontChannelLoginUriEntry
	nil,                                   // 57: indykite.config.v1beta1.OAuth2ProviderConfig.FrontChannelConsentUriEntry
	nil,                                   // 58: indykite.config.v1beta1.WebAuthnProviderConfig.RelyingPartiesEntry
	nil,                                   // 59: indykite.config.v1beta1.MailJetProviderConfig.UrlTagsEntry
	nil,                                   // 60: indykite.config.v1beta1.EmailTemplate.HeadersEntry
	nil,                                   // 61: indykite.config.v1beta1.EmailTemplate.CustomArgsEntry
	nil,                                   // 62: indykite.config.v1beta1.EmailTemplate.DynamicTemplateValuesEntry
	nil,                                   // 63: indykite.config.v1beta1.EmailMessage.HeadersEntry
	nil,                                   // 64: indykite.config.v1beta1.EmailMessage.CustomArgsEntry
	nil,                                   // 65: indykite.config.v1beta1.EmailMessage.DynamicTemplateValuesEntry
	(*TokenExchangeConfig_JWT)(nil),       // 66: indykite.config.v1beta1.TokenExchangeConfig.JWT
	(*TokenExchangeConfig_Offline)(nil),   // 67: indykite.config.v1beta1.TokenExchangeConfig.Offline
	(*TokenExchangeConfig_Claim)(nil),     // 68: indykite.config.v1beta1.TokenExchangeConfig.Claim
	nil,                                   // 69: indykite.config.v1beta1.TokenExchangeConfig.ClaimsMappingEntry
	...
	(*PolicyBuilderConfig)(nil),           // 74: indykite.config.v1beta1.PolicyBuilderConfig
	(*v1beta1.Value)(nil),                 // 75: indykite.objects.v1beta1.Value
}
var file_indykite_config_v1beta1_model_proto_depIdxs = []int32{
	70,  // 0: indykite.config.v1beta1.Customer.description:type_name -> google.protobuf.StringValue
	71,  // 1: indykite.config.v1beta1.Customer.create_time:type_name -> google.protobuf.Timestamp
	71,  // 2: indykite.config.v1beta1.Customer.update_time:type_name -> google.protobuf.Timestamp
	71,  // 3: indykite.config.v1beta1.Customer.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 4: indykite.config.v1beta1.Customer.delete_time:type_name -> google.protobuf.Timestamp
	70,  // 5: indykite.config.v1beta1.ApplicationSpace.description:type_name -> google.protobuf.StringValue
	71,  // 6: indykite.config.v1beta1.ApplicationSpace.create_time:type_name -> google.protobuf.Timestamp
	71,  // 7: indykite.config.v1beta1.ApplicationSpace.update_time:type_name -> google.protobuf.Timestamp
	71,  // 8: indykite.config.v1beta1.ApplicationSpace.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 9: indykite.config.v1beta1.ApplicationSpace.delete_time:type_name -> google.protobuf.Timestamp
	0,   // 10: indykite.config.v1beta1.ApplicationSpace.ikg_status:type_name -> indykite.config.v1beta1.AppSpaceIKGStatus
	55,  // 11: indykite.config.v1beta1.ApplicationSpaceConfig.unique_property_constraints:type_name -> indykite.config.v1beta1.ApplicationSpaceConfig.UniquePropertyConstraintsEntry
	47,  // 12: indykite.config.v1beta1.ApplicationSpaceConfig.username_policy:type_name -> indykite.config.v1beta1.UsernamePolicy
	70,  // 13: indykite.config.v1beta1.Tenant.description:type_name -> google.protobuf.StringValue
	71,  // 14: indykite.config.v1beta1.Tenant.create_time:type_name -> google.protobuf.Timestamp
	71,  // 15: indykite.config.v1beta1.Tenant.update_time:type_name -> google.protobuf.Timestamp
	71,  // 16: indykite.config.v1beta1.Tenant.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 17: indykite.config.v1beta1.Tenant.delete_time:type_name -> google.protobuf.Timestamp
	47,  // 18: indykite.config.v1beta1.TenantConfig.username_policy:type_name -> indykite.config.v1beta1.UsernamePolicy
	70,  // 19: indykite.config.v1beta1.Application.description:type_name -> google.protobuf.StringValue
	71,  // 20: indykite.config.v1beta1.Application.create_time:type_name -> google.protobuf.Timestamp
	71,  // 21: indykite.config.v1beta1.Application.update_time:type_name -> google.protobuf.Timestamp
	71,  // 22: indykite.config.v1beta1.Application.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 23: indykite.config.v1beta1.Application.delete_time:type_name -> google.protobuf.Timestamp
	70,  // 24: indykite.config.v1beta1.ApplicationAgent.description:type_name -> google.protobuf.StringValue
	71,  // 25: indykite.config.v1beta1.ApplicationAgent.create_time:type_name -> google.protobuf.Timestamp
	71,  // 26: indykite.config.v1beta1.ApplicationAgent.update_time:type_name -> google.protobuf.Timestamp
	71,  // 27: indykite.config.v1beta1.ApplicationAgent.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 28: indykite.config.v1beta1.ApplicationAgent.delete_time:type_name -> google.protobuf.Timestamp
	71,  // 29: indykite.config.v1beta1.ApplicationAgentCredential.create_time:type_name -> google.protobuf.Timestamp
	71,  // 30: indykite.config.v1beta1.ApplicationAgentCredential.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 31: indykite.config.v1beta1.ApplicationAgentCredential.delete_time:type_name -> google.protobuf.Timestamp
	70,  // 32: indykite.config.v1beta1.ServiceAccount.description:type_name -> google.protobuf.StringValue
	71,  // 33: indykite.config.v1beta1.ServiceAccount.create_time:type_name -> google.protobuf.Timestamp
	71,  // 34: indykite.config.v1beta1.ServiceAccount.update_time:type_name -> google.protobuf.Timestamp
	71,  // 35: indykite.config.v1beta1.ServiceAccount.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 36: indykite.config.v1beta1.ServiceAccount.delete_time:type_name -> google.protobuf.Timestamp
	71,  // 37: indykite.config.v1beta1.ServiceAccountCredential.create_time:type_name -> google.protobuf.Timestamp
	71,  // 38: indykite.config.v1beta1.ServiceAccountCredential.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 39: indykite.config.v1beta1.ServiceAccountCredential.delete_time:type_name -> google.protobuf.Timestamp
	70,  // 40: indykite.config.v1beta1.ConfigNode.description:type_name -> google.protobuf.StringValue
	71,  // 41: indykite.config.v1beta1.ConfigNode.create_time:type_name -> google.protobuf.Timestamp
	71,  // 42: indykite.config.v1beta1.ConfigNode.update_time:type_name -> google.protobuf.Timestamp
	71,  // 43: indykite.config.v1beta1.ConfigNode.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 44: indykite.config.v1beta1.ConfigNode.delete_time:type_name -> google.protobuf.Timestamp
	33,  // 45: indykite.config.v1beta1.ConfigNode.auth_flow_config:type_name -> indykite.config.v1beta1.AuthFlowConfig
	36,  // 46: indykite.config.v1beta1.ConfigNode.email_service_config:type_name -> indykite.config.v1beta1.EmailServiceConfig
	51,  // 47: indykite.config.v1beta1.ConfigNode.audit_sink_config:type_name -> indykite.config.v1beta1.AuditSinkConfig
	26,  // 48: indykite.config.v1beta1.ConfigNode.oauth2_client_config:type_name -> indykite.config.v1beta1.OAuth2ClientConfig
	46,  // 49: indykite.config.v1beta1.ConfigNode.password_provider_config:type_name -> indykite.config.v1beta1.PasswordProviderConfig
	31,  // 50: indykite.config.v1beta1.ConfigNode.webauthn_provider_config:type_name -> indykite.config.v1beta1.WebAuthnProviderConfig
	34,  // 51: indykite.config.v1beta1.ConfigNode.safr_provider_config:type_name -> indykite.config.v1beta1.SAFRProviderConfig
	50,  // 52: indykite.config.v1beta1.ConfigNode.authorization_policy_config:type_name -> indykite.config.v1beta1.AuthorizationPolicyConfig
	53,  // 53: indykite.config.v1beta1.ConfigNode.consent_config:type_name -> indykite.config.v1beta1.ConsentConfiguration
	54,  // 54: indykite.config.v1beta1.ConfigNode.token_exchange_config:type_name -> indykite.config.v1beta1.TokenExchangeConfig
	1,   // 55: indykite.config.v1beta1.OAuth2ClientConfig.provider_type:type_name -> indykite.config.v1beta1.ProviderType
	2,   // 56: indykite.config.v1beta1.OAuth2ClientConfig.auth_style:type_name -> indykite.config.v1beta1.AuthStyle
	70,  // 57: indykite.config.v1beta1.OAuth2Application.description:type_name -> google.protobuf.StringValue
	71,  // 58: indykite.config.v1beta1.OAuth2Application.create_time:type_name -> google.protobuf.Timestamp
	71,  // 59: indykite.config.v1beta1.OAuth2Application.update_time:type_name -> google.protobuf.Timestamp
	71,  // 60: indykite.config.v1beta1.OAuth2Application.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 61: indykite.config.v1beta1.OAuth2Application.delete_time:type_name -> google.protobuf.Timestamp
	28,  // 62: indykite.config.v1beta1.OAuth2Application.config:type_name -> indykite.config.v1beta1.OAuth2ApplicationConfig
	5,   // 63: indykite.config.v1beta1.OAuth2ApplicationConfig.subject_type:type_name -> indykite.config.v1beta1.ClientSubjectType
	3,   // 64: indykite.config.v1beta1.OAuth2ApplicationConfig.grant_types:type_name -> indykite.config.v1beta1.GrantType
	4,   // 65: indykite.config.v1beta1.OAuth2ApplicationConfig.response_types:type_name -> indykite.config.v1beta1.ResponseType
	6,   // 66: indykite.config.v1beta1.OAuth2ApplicationConfig.token_endpoint_auth_method:type_name -> indykite.config.v1beta1.TokenEndpointAuthMethod
	70,  // 67: indykite.config.v1beta1.OAuth2Provider.description:type_name -> google.protobuf.StringValue
	71,  // 68: indykite.config.v1beta1.OAuth2Provider.create_time:type_name -> google.protobuf.Timestamp
	71,  // 69: indykite.config.v1beta1.OAuth2Provider.update_time:type_name -> google.protobuf.Timestamp
	71,  // 70: indykite.config.v1beta1.OAuth2Provider.destroy_time:type_name -> google.protobuf.Timestamp
	71,  // 71: indykite.config.v1beta1.OAuth2Provider.delete_time:type_name -> google.protobuf.Timestamp
	30,  // 72: indykite.config.v1beta1.OAuth2Provider.config:type_name -> indykite.config.v1beta1.OAuth2ProviderConfig
	3,   // 73: indykite.config.v1beta1.OAuth2ProviderConfig.grant_types:type_name -> indykite.config.v1beta1.GrantType
	4,   // 74: indykite.config.v1beta1.OAuth2ProviderConfig.response_types:type_name -> indykite.config.v1beta1.ResponseType
	6,   // 75: indykite.config.v1beta1.OAuth2ProviderConfig.token_endpoint_auth_method:type_name -> indykite.config.v1beta1.TokenEndpointAuthMethod
	56,  // 76: indykite.config.v1beta1.OAuth2ProviderConfig.front_channel_login_uri:type_name -> indykite.config.v1beta1.OAuth2ProviderConfig.FrontChannelLoginUriEntry
	57,  // 77: indykite.config.v1beta1.OAuth2ProviderConfig.front_channel_consent_uri:type_name -> indykite.config.v1beta1.OAuth2ProviderConfig.FrontChannelConsentUriEntry
	58,  // 78: indykite.config.v1beta1.WebAuthnProviderConfig.relying_parties:type_name -> indykite.config.v1beta1.WebAuthnProviderConfig.RelyingPartiesEntry
	7,   // 79: indykite.config.v1beta1.WebAuthnProviderConfig.attestation_preference:type_name -> indykite.config.v1beta1.ConveyancePreference
	8,   // 80: indykite.config.v1beta1.WebAuthnProviderConfig.authenticator_attachment:type_name -> indykite.config.v1beta1.AuthenticatorAttachment
	9,   // 81: indykite.config.v1beta1.WebAuthnProviderConfig.user_verification:type_name -> indykite.config.v1beta1.UserVerificationRequirement
	72,  // 82: indykite.config.v1beta1.WebAuthnProviderConfig.registration_timeout:type_name -> google.protobuf.Duration
	72,  // 83: indykite.config.v1beta1.WebAuthnProviderConfig.authentication_timeout:type_name -> google.protobuf.Duration
	11,  // 84: indykite.config.v1beta1.AuthFlowConfig.source_format:type_name -> indykite.config.v1beta1.AuthFlowConfig.Format
	37,  // 85: indykite.config.v1beta1.EmailServiceConfig.default_from_address:type_name -> indykite.config.v1beta1.Email
	38,  // 86: indykite.config.v1beta1.EmailServiceConfig.sendgrid:type_name -> indykite.config.v1beta1.SendGridProviderConfig
	39,  // 87: indykite.config.v1beta1.EmailServiceConfig.mailjet:type_name -> indykite.config.v1beta1.MailJetProviderConfig
	40,  // 88: indykite.config.v1beta1.EmailServiceConfig.mailgun:type_name -> indykite.config.v1beta1.MailgunProviderConfig
	41,  // 89: indykite.config.v1beta1.EmailServiceConfig.amazon:type_name -> indykite.config.v1beta1.AmazonSESProviderConfig
	42,  // 90: indykite.config.v1beta1.EmailServiceConfig.invitation_message:type_name -> indykite.config.v1beta1.EmailDefinition
	42,  // 91: indykite.config.v1beta1.EmailServiceConfig.reset_password_message:type_name -> indykite.config.v1beta1.EmailDefinition
	42,  // 92: indykite.config.v1beta1.EmailServiceConfig.verification_message:type_name -> indykite.config.v1beta1.EmailDefinition
	42,  // 93: indykite.config.v1beta1.EmailServiceConfig.one_time_password_message:type_name -> indykite.config.v1beta1.EmailDefinition
	42,  // 94: indykite.config.v1beta1.EmailServiceConfig.app_space_ready_to_use_message:type_name -> indykite.config.v1beta1.EmailDefinition
	70,  // 95: indykite.config.v1beta1.SendGridProviderConfig.ip_pool_name:type_name -> google.protobuf.StringValue
	70,  // 96: indykite.config.v1beta1.SendGridProviderConfig.host:type_name -> google.protobuf.StringValue
	59,  // 97: indykite.config.v1beta1.MailJetProviderConfig.url_tags:type_name -> indykite.config.v1beta1.MailJetProviderConfig.UrlTagsEntry
	70,  // 98: indykite.config.v1beta1.MailJetProviderConfig.custom_campaign:type_name -> google.protobuf.StringValue
	37,  // 99: indykite.config.v1beta1.MailgunProviderConfig.default_from_address:type_name -> indykite.config.v1beta1.Email
	37,  // 100: indykite.config.v1beta1.AmazonSESProviderConfig.default_from_address:type_name -> indykite.config.v1beta1.Email
	43,  // 101: indykite.config.v1beta1.EmailDefinition.template:type_name -> indykite.config.v1beta1.EmailTemplate
	45,  // 102: indykite.config.v1beta1.EmailDefinition.message:type_name -> indykite.config.v1beta1.EmailMessage
	70,  // 103: indykite.config.v1beta1.EmailTemplate.template_version:type_name -> google.protobuf.StringValue
	37,  // 104: indykite.config.v1beta1.EmailTemplate.from:type_name -> indykite.config.v1beta1.Email
	37,  // 105: indykite.config.v1beta1.EmailTemplate.reply_to:type_name -> indykite.config.v1beta1.Email
	37,  // 106: indykite.config.v1beta1.EmailTemplate.to:type_name -> indykite.config.v1beta1.Email
	37,  // 107: indykite.config.v1beta1.EmailTemplate.cc:type_name -> indykite.config.v1beta1.Email
	37,  // 108: indykite.config.v1beta1.EmailTemplate.bcc:type_name -> indykite.config.v1beta1.Email
	60,  // 109: indykite.config.v1beta1.EmailTemplate.headers:type_name -> indykite.config.v1beta1.EmailTemplate.HeadersEntry
	61,  // 110: indykite.config.v1beta1.EmailTemplate.custom_args:type_name -> indykite.config.v1beta1.EmailTemplate.CustomArgsEntry
	62,  // 111: indykite.config.v1beta1.EmailTemplate.dynamic_template_values:type_name -> indykite.config.v1beta1.EmailTemplate.DynamicTemplateValuesEntry
	44,  // 112: indykite.config.v1beta1.EmailTemplate.attachments:type_name -> indykite.config.v1beta1.EmailAttachment
	70,  // 113: indykite.config.v1beta1.EmailTemplate.event_payload:type_name -> google.protobuf.StringValue
	70,  // 114: indykite.config.v1beta1.EmailAttachment.content_id:type_name -> google.protobuf.StringValue
	37,  // 115: indykite.config.v1beta1.EmailMessage.from:type_name -> indykite.config.v1beta1.Email
	37,  // 116: indykite.config.v1beta1.EmailMessage.reply_to:type_name -> indykite.config.v1beta1.Email
	37,  // 117: indykite.config.v1beta1.EmailMessage.to:type_name -> indykite.config.v1beta1.Email
	37,  // 118: indykite.config.v1beta1.EmailMessage.cc:type_name -> indykite.config.v1beta1.Email
	37,  // 119: indykite.config.v1beta1.EmailMessage.bcc:type_name -> indykite.config.v1beta1.Email
	63,  // 120: indykite.config.v1beta1.EmailMessage.headers:type_name -> indykite.config.v1beta1.EmailMessage.HeadersEntry
	64,  // 121: indykite.config.v1beta1.EmailMessage.custom_args:type_name -> indykite.config.v1beta1.EmailMessage.CustomArgsEntry
	65,  // 122: indykite.config.v1beta1.EmailMessage.dynamic_template_values:type_name -> indykite.config.v1beta1.EmailMessage.DynamicTemplateValuesEntry
	44,  // 123: indykite.config.v1beta1.EmailMessage.attachments:type_name -> indykite.config.v1beta1.EmailAttachment
	70,  // 124: indykite.config.v1beta1.EmailMessage.event_payload:type_name -> google.protobuf.StringValue
	47,  // 125: indykite.config.v1beta1.PasswordProviderConfig.username_policy:type_name -> indykite.config.v1beta1.UsernamePolicy
	49,  // 126: indykite.config.v1beta1.PasswordProviderConfig.password_policy:type_name -> indykite.config.v1beta1.PasswordPolicy
	72,  // 127: indykite.config.v1beta1.PasswordProviderConfig.fail_interval:type_name -> google.protobuf.Duration
	72,  // 128: indykite.config.v1beta1.PasswordProviderConfig.minimum_password_lifetime:type_name -> google.protobuf.Duration
	72,  // 129: indykite.config.v1beta1.PasswordProviderConfig.maximum_password_lifetime:type_name -> google.protobuf.Duration
	72,  // 130: indykite.config.v1beta1.PasswordProviderConfig.lockout_time:type_name -> google.protobuf.Duration
	72,  // 131: indykite.config.v1beta1.UsernamePolicy.verify_email_grace_period:type_name -> google.protobuf.Duration
	10,  // 132: indykite.config.v1beta1.PasswordPolicy.template:type_name -> indykite.config.v1beta1.PasswordPolicyTemplate
	73,  // 133: indykite.config.v1beta1.PasswordPolicy.minimum_length:type_name -> google.protobuf.Int64Value
	12,  // 134: indykite.config.v1beta1.AuthorizationPolicyConfig.status:type_name -> indykite.config.v1beta1.AuthorizationPolicyConfig.Status
	74,  // 135: indykite.config.v1beta1.AuthorizationPolicyConfig.builder:type_name -> indykite.config.v1beta1.PolicyBuilderConfig
	52,  // 136: indykite.config.v1beta1.AuditSinkConfig.kafka:type_name -> indykite.config.v1beta1.KafkaSinkConfig
	66,  // 137: indykite.config.v1beta1.TokenExchangeConfig.jwt:type_name -> indykite.config.v1beta1.TokenExchangeConfig.JWT
	67,  // 138: indykite.config.v1beta1.TokenExchangeConfig.offline:type_name -> indykite.config.v1beta1.TokenExchangeConfig.Offline
	69,  // 139: indykite.config.v1beta1.TokenExchangeConfig.claims_mapping:type_name -> indykite.config.v1beta1.TokenExchangeConfig.ClaimsMappingEntry
	48,  // 140: indykite.config.v1beta1.ApplicationSpaceConfig.UniquePropertyConstraintsEntry.value:type_name -> indykite.config.v1beta1.UniquePropertyConstraint
	75,  // 141: indykite.config.v1beta1.EmailTemplate.DynamicTemplateValuesEntry.value:type_name -> indykite.objects.v1beta1.Value
	75,  // 142: indykite.config.v1beta1.EmailMessage.DynamicTemplateValuesEntry.value:type_name -> indykite.objects.v1beta1.Value
	68,  // 143: indykite.config.v1beta1.TokenExchangeConfig.ClaimsMappingEntry.value:type_name -> indykite.config.v1beta1.TokenExchangeConfig.Claim
...
func file_indykite_config_v1beta1_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_indykite_config_v1beta1_model_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UniquePropertyConstraint); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indykite_config_v1beta1_model_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
		...
		file_indykite_config_v1beta1_model_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
		...
		file_indykite_config_v1beta1_model_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
		...
		file_indykite_config_v1beta1_model_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenExchangeConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indykite_config_v1beta1_model_proto_msgTypes[53].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenExchangeConfig_JWT); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indykite_config_v1beta1_model_proto_msgTypes[54].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenExchangeConfig_Offline); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indykite_config_v1beta1_model_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenExchangeConfig_Claim); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_indykite_config_v1beta1_model_proto_msgTypes[12].OneofWrappers = []interface{}{
		...
		(*ConfigNode_TokenExchangeConfig)(nil),
	}
	file_indykite_config_v1beta1_model_proto_msgTypes[23].OneofWrappers = []interface{}{
		(*EmailServiceConfig_Sendgrid)(nil),
		(*EmailServiceConfig_Mailjet)(nil),
		(*EmailServiceConfig_Mailgun)(nil),
		(*EmailServiceConfig_Amazon)(nil),
	}
	file_indykite_config_v1beta1_model_proto_msgTypes[29].OneofWrappers = []interface{}{
		(*EmailDefinition_Template)(nil),
		(*EmailDefinition_Message)(nil),
	}
	file_indykite_config_v1beta1_model_proto_msgTypes[38].OneofWrappers = []interface{}{
		(*AuditSinkConfig_Kafka)(nil),
	}
	file_indykite_config_v1beta1_model_proto_msgTypes[41].OneofWrappers = []interface{}{
		(*TokenExchangeConfig_Jwt)(nil),
		(*TokenExchangeConfig_Offline_)(nil),
	}
	type x struct{}
