...
var file_indykite_config_v1beta1_config_management_api_proto_rawDesc = []byte{
	...
	0x67, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x65, 0x74, 0x61, 0x67, 0x12, 0x1a, 0x0a,
	0x08, 0x62, 0x6f, 0x6f, 0x6b, 0x6d, 0x61, 0x72, 0x6b, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x62, 0x6f, 0x6f, 0x6b, 0x6d, 0x61, 0x72, 0x6b, 0x22, 0xf5, 0x0a, 0x0a, 0x17, 0x43, 0x72,
	...
	0x6f, 0x6e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x40,
	...
	0xd3, 0x0a, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x40, 0x0a, 0x09, 0x62, 0x6f, 0x6f, 0x6b, 0x6d,
...
var file_indykite_config_v1beta1_config_management_api_proto_goTypes = []interface{}{
	...
	(*ConfigNode)(nil),                                 // 133: indykite.config.v1beta1.ConfigNode
	(*OAuth2ProviderConfig)(nil),                       // 134: indykite.config.v1beta1.OAuth2ProviderConfig
	(*OAuth2Provider)(nil),                             // 135: indykite.config.v1beta1.OAuth2Provider
	(*OAuth2ApplicationConfig)(nil),                    // 136: indykite.config.v1beta1.OAuth2ApplicationConfig
	(*OAuth2Application)(nil),                          // 137: indykite.config.v1beta1.OAuth2Application
}
var file_indykite_config_v1beta1_config_management_api_proto_depIdxs = []int32{
	...
	112, // 107: indykite.config.v1beta1.CreateConfigNodeResponse.create_time:type_name -> google.protobuf.Timestamp
	112, // 108: indykite.config.v1beta1.CreateConfigNodeResponse.update_time:type_name -> google.protobuf.Timestamp
	133, // 109: indykite.config.v1beta1.ReadConfigNodeResponse.config_node:type_name -> indykite.config.v1beta1.ConfigNode
	113, // 110: indykite.config.v1beta1.UpdateConfigNodeRequest.etag:type_name -> google.protobuf.StringValue
	113, // 111: indykite.config.v1beta1.UpdateConfigNodeRequest.display_name:type_name -> google.protobuf.StringValue
	113, // 112: indykite.config.v1beta1.UpdateConfigNodeRequest.description:type_name -> google.protobuf.StringValue
	124, // 113: indykite.config.v1beta1.UpdateConfigNodeRequest.auth_flow_config:type_name -> indykite.config.v1beta1.AuthFlowConfig
	125, // 114: indykite.config.v1beta1.UpdateConfigNodeRequest.email_service_config:type_name -> indykite.config.v1beta1.EmailServiceConfig
	126, // 115: indykite.config.v1beta1.UpdateConfigNodeRequest.sms_service_config:type_name -> indykite.config.v1beta1.SMSServiceConfig
	127, // 116: indykite.config.v1beta1.UpdateConfigNodeRequest.audit_sink_config:type_name -> indykite.config.v1beta1.AuditSinkConfig
	128, // 117: indykite.config.v1beta1.UpdateConfigNodeRequest.oauth2_client_config:type_name -> indykite.config.v1beta1.OAuth2ClientConfig
	129, // 118: indykite.config.v1beta1.UpdateConfigNodeRequest.password_provider_config:type_name -> indykite.config.v1beta1.PasswordProviderConfig
	130, // 119: indykite.config.v1beta1.UpdateConfigNodeRequest.webauthn_provider_config:type_name -> indykite.config.v1beta1.WebAuthnProviderConfig
	131, // 120: indykite.config.v1beta1.UpdateConfigNodeRequest.safr_provider_config:type_name -> indykite.config.v1beta1.SAFRProviderConfig
	132, // 121: indykite.config.v1beta1.UpdateConfigNodeRequest.authorization_policy_config:type_name -> indykite.config.v1beta1.AuthorizationPolicyConfig
	112, // 122: indykite.config.v1beta1.UpdateConfigNodeResponse.create_time:type_name -> google.protobuf.Timestamp
	112, // 123: indykite.config.v1beta1.UpdateConfigNodeResponse.update_time:type_name -> google.protobuf.Timestamp
	113, // 124: indykite.config.v1beta1.DeleteConfigNodeRequest.etag:type_name -> google.protobuf.StringValue
	133, // 125: indykite.config.v1beta1.ListConfigNodeVersionsResponse.config_nodes:type_name -> indykite.config.v1beta1.ConfigNode
	113, // 126: indykite.config.v1beta1.CreateOAuth2ProviderRequest.display_name:type_name -> google.protobuf.StringValue
	113, // 127: indykite.config.v1beta1.CreateOAuth2ProviderRequest.description:type_name -> google.protobuf.StringValue
	134, // 128: indykite.config.v1beta1.CreateOAuth2ProviderRequest.config:type_name -> indykite.config.v1beta1.OAuth2ProviderConfig
	112, // 129: indykite.config.v1beta1.CreateOAuth2ProviderResponse.create_time:type_name -> google.protobuf.Timestamp
	112, // 130: indykite.config.v1beta1.CreateOAuth2ProviderResponse.update_time:type_name -> google.protobuf.Timestamp
	135, // 131: indykite.config.v1beta1.ReadOAuth2ProviderResponse.oauth2_provider:type_name -> indykite.config.v1beta1.OAuth2Provider
	113, // 132: indykite.config.v1beta1.UpdateOAuth2ProviderRequest.etag:type_name -> google.protobuf.StringValue
	113, // 133: indykite.config.v1beta1.UpdateOAuth2ProviderRequest.display_name:type_name -> google.protobuf.StringValue
	113, // 134: indykite.config.v1beta1.UpdateOAuth2ProviderRequest.description:type_name -> google.protobuf.StringValue
	134, // 135: indykite.config.v1beta1.UpdateOAuth2ProviderRequest.config:type_name -> indykite.config.v1beta1.OAuth2ProviderConfig
	112, // 136: indykite.config.v1beta1.UpdateOAuth2ProviderResponse.create_time:type_name -> google.protobuf.Timestamp
	112, // 137: indykite.config.v1beta1.UpdateOAuth2ProviderResponse.update_time:type_name -> google.protobuf.Timestamp
	113, // 138: indykite.config.v1beta1.DeleteOAuth2ProviderRequest.etag:type_name -> google.protobuf.StringValue
	113, // 139: indykite.config.v1beta1.CreateOAuth2ApplicationRequest.display_name:type_name -> google.protobuf.StringValue
	113, // 140: indykite.config.v1beta1.CreateOAuth2ApplicationRequest.description:type_name -> google.protobuf.StringValue
	136, // 141: indykite.config.v1beta1.CreateOAuth2ApplicationRequest.config:type_name -> indykite.config.v1beta1.OAuth2ApplicationConfig
	112, // 142: indykite.config.v1beta1.CreateOAuth2ApplicationResponse.create_time:type_name -> google.protobuf.Timestamp
	112, // 143: indykite.config.v1beta1.CreateOAuth2ApplicationResponse.update_time:type_name -> google.protobuf.Timestamp
	137, // 144: indykite.config.v1beta1.ReadOAuth2ApplicationResponse.oauth2_application:type_name -> indykite.config.v1beta1.OAuth2Application
	113, // 145: indykite.config.v1beta1.UpdateOAuth2ApplicationRequest.etag:type_name -> google.protobuf.StringValue
	113, // 146: indykite.config.v1beta1.UpdateOAuth2ApplicationRequest.display_name:type_name -> google.protobuf.StringValue
	113, // 147: indykite.config.v1beta1.UpdateOAuth2ApplicationRequest.description:type_name -> google.protobuf.StringValue
	136, // 148: indykite.config.v1beta1.UpdateOAuth2ApplicationRequest.config:type_name -> indykite.config.v1beta1.OAuth2ApplicationConfig
	112, // 149: indykite.config.v1beta1.UpdateOAuth2ApplicationResponse.create_time:type_name -> google.protobuf.Timestamp
	112, // 150: indykite.config.v1beta1.UpdateOAuth2ApplicationResponse.update_time:type_name -> google.protobuf.Timestamp
	113, // 151: indykite.config.v1beta1.DeleteOAuth2ApplicationRequest.etag:type_name -> google.protobuf.StringValue
	107, // 152: indykite.config.v1beta1.ListPermissionsResponse.users:type_name -> indykite.config.v1beta1.ListPermissionsResponse.User
	108, // 153: indykite.config.v1beta1.ListPermissionsResponse.service_accounts:type_name -> indykite.config.v1beta1.ListPermissionsResponse.ServiceAccount
	109, // 154: indykite.config.v1beta1.ListPermissionsResponse.invitations:type_name -> indykite.config.v1beta1.ListPermissionsResponse.Invitation
	106, // 155: indykite.config.v1beta1.ListPermissionsResponse.User.roles:type_name -> indykite.config.v1beta1.ListPermissionsResponse.PermissionRole
	106, // 156: indykite.config.v1beta1.ListPermissionsResponse.ServiceAccount.roles:type_name -> indykite.config.v1beta1.ListPermissionsResponse.PermissionRole
	106, // 157: indykite.config.v1beta1.ListPermissionsResponse.Invitation.roles:type_name -> indykite.config.v1beta1.ListPermissionsResponse.PermissionRole
	0,   // 158: indykite.config.v1beta1.ConfigManagementAPI.ReadCustomer:input_type -> indykite.config.v1beta1.ReadCustomerRequest
	2,   // 159: indykite.config.v1beta1.ConfigManagementAPI.ReadCustomerConfig:input_type -> indykite.config.v1beta1.ReadCustomerConfigRequest
	4,   // 160: indykite.config.v1beta1.ConfigManagementAPI.UpdateCustomerConfig:input_type -> indykite.config.v1beta1.UpdateCustomerConfigRequest
	6,   // 161: indykite.config.v1beta1.ConfigManagementAPI.CreateApplicationSpace:input_type -> indykite.config.v1beta1.CreateApplicationSpaceRequest
	8,   // 162: indykite.config.v1beta1.ConfigManagementAPI.ReadApplicationSpace:input_type -> indykite.config.v1beta1.ReadApplicationSpaceRequest
	10,  // 163: indykite.config.v1beta1.ConfigManagementAPI.ListApplicationSpaces:input_type -> indykite.config.v1beta1.ListApplicationSpacesRequest
	12,  // 164: indykite.config.v1beta1.ConfigManagementAPI.UpdateApplicationSpace:input_type -> indykite.config.v1beta1.UpdateApplicationSpaceRequest
	14,  // 165: indykite.config.v1beta1.ConfigManagementAPI.DeleteApplicationSpace:input_type -> indykite.config.v1beta1.DeleteApplicationSpaceRequest
	16,  // 166: indykite.config.v1beta1.ConfigManagementAPI.ReadApplicationSpaceConfig:input_type -> indykite.config.v1beta1.ReadApplicationSpaceConfigRequest
	18,  // 167: indykite.config.v1beta1.ConfigManagementAPI.UpdateApplicationSpaceConfig:input_type -> indykite.config.v1beta1.UpdateApplicationSpaceConfigRequest
	20,  // 168: indykite.config.v1beta1.ConfigManagementAPI.CreateApplication:input_type -> indykite.config.v1beta1.CreateApplicationRequest
	22,  // 169: indykite.config.v1beta1.ConfigManagementAPI.ReadApplication:input_type -> indykite.config.v1beta1.ReadApplicationRequest
	24,  // 170: indykite.config.v1beta1.ConfigManagementAPI.ListApplications:input_type -> indykite.config.v1beta1.ListApplicationsRequest
	26,  // 171: indykite.config.v1beta1.ConfigManagementAPI.UpdateApplication:input_type -> indykite.config.v1beta1.UpdateApplicationRequest
	28,  // 172: indykite.config.v1beta1.ConfigManagementAPI.DeleteApplication:input_type -> indykite.config.v1beta1.DeleteApplicationRequest
	30,  // 173: indykite.config.v1beta1.ConfigManagementAPI.CreateApplicationAgent:input_type -> indykite.config.v1beta1.CreateApplicationAgentRequest
	32,  // 174: indykite.config.v1beta1.ConfigManagementAPI.ReadApplicationAgent:input_type -> indykite.config.v1beta1.ReadApplicationAgentRequest
	34,  // 175: indykite.config.v1beta1.ConfigManagementAPI.ListApplicationAgents:input_type -> indykite.config.v1beta1.ListApplicationAgentsRequest
	36,  // 176: indykite.config.v1beta1.ConfigManagementAPI.UpdateApplicationAgent:input_type -> indykite.config.v1beta1.UpdateApplicationAgentRequest
	38,  // 177: indykite.config.v1beta1.ConfigManagementAPI.DeleteApplicationAgent:input_type -> indykite.config.v1beta1.DeleteApplicationAgentRequest
	40,  // 178: indykite.config.v1beta1.ConfigManagementAPI.RegisterApplicationAgentCredential:input_type -> indykite.config.v1beta1.RegisterApplicationAgentCredentialRequest
	42,  // 179: indykite.config.v1beta1.ConfigManagementAPI.ReadApplicationAgentCredential:input_type -> indykite.config.v1beta1.ReadApplicationAgentCredentialRequest
	44,  // 180: indykite.config.v1beta1.ConfigManagementAPI.DeleteApplicationAgentCredential:input_type -> indykite.config.v1beta1.DeleteApplicationAgentCredentialRequest
	46,  // 181: indykite.config.v1beta1.ConfigManagementAPI.CreateServiceAccount:input_type -> indykite.config.v1beta1.CreateServiceAccountRequest
	48,  // 182: indykite.config.v1beta1.ConfigManagementAPI.ReadServiceAccount:input_type -> indykite.config.v1beta1.ReadServiceAccountRequest
	50,  // 183: indykite.config.v1beta1.ConfigManagementAPI.UpdateServiceAccount:input_type -> indykite.config.v1beta1.UpdateServiceAccountRequest
	52,  // 184: indykite.config.v1beta1.ConfigManagementAPI.DeleteServiceAccount:input_type -> indykite.config.v1beta1.DeleteServiceAccountRequest
	54,  // 185: indykite.config.v1beta1.ConfigManagementAPI.RegisterServiceAccountCredential:input_type -> indykite.config.v1beta1.RegisterServiceAccountCredentialRequest
	56,  // 186: indykite.config.v1beta1.ConfigManagementAPI.ReadServiceAccountCredential:input_type -> indykite.config.v1beta1.ReadServiceAccountCredentialRequest
	58,  // 187: indykite.config.v1beta1.ConfigManagementAPI.DeleteServiceAccountCredential:input_type -> indykite.config.v1beta1.DeleteServiceAccountCredentialRequest
	60,  // 188: indykite.config.v1beta1.ConfigManagementAPI.CreateTenant:input_type -> indykite.config.v1beta1.CreateTenantRequest
	62,  // 189: indykite.config.v1beta1.ConfigManagementAPI.ReadTenant:input_type -> indykite.config.v1beta1.ReadTenantRequest
	64,  // 190: indykite.config.v1beta1.ConfigManagementAPI.ListTenants:input_type -> indykite.config.v1beta1.ListTenantsRequest
	66,  // 191: indykite.config.v1beta1.ConfigManagementAPI.UpdateTenant:input_type -> indykite.config.v1beta1.UpdateTenantRequest
	68,  // 192: indykite.config.v1beta1.ConfigManagementAPI.DeleteTenant:input_type -> indykite.config.v1beta1.DeleteTenantRequest
	70,  // 193: indykite.config.v1beta1.ConfigManagementAPI.ReadTenantConfig:input_type -> indykite.config.v1beta1.ReadTenantConfigRequest
	72,  // 194: indykite.config.v1beta1.ConfigManagementAPI.UpdateTenantConfig:input_type -> indykite.config.v1beta1.UpdateTenantConfigRequest
	74,  // 195: indykite.config.v1beta1.ConfigManagementAPI.CreateConfigNode:input_type -> indykite.config.v1beta1.CreateConfigNodeRequest
	76,  // 196: indykite.config.v1beta1.ConfigManagementAPI.ReadConfigNode:input_type -> indykite.config.v1beta1.ReadConfigNodeRequest
	78,  // 197: indykite.config.v1beta1.ConfigManagementAPI.UpdateConfigNode:input_type -> indykite.config.v1beta1.UpdateConfigNodeRequest
	80,  // 198: indykite.config.v1beta1.ConfigManagementAPI.DeleteConfigNode:input_type -> indykite.config.v1beta1.DeleteConfigNodeRequest
	81,  // 199: indykite.config.v1beta1.ConfigManagementAPI.ListConfigNodeVersions:input_type -> indykite.config.v1beta1.ListConfigNodeVersionsRequest
	84,  // 200: indykite.config.v1beta1.ConfigManagementAPI.CreateOAuth2Provider:input_type -> indykite.config.v1beta1.CreateOAuth2ProviderRequest
	86,  // 201: indykite.config.v1beta1.ConfigManagementAPI.ReadOAuth2Provider:input_type -> indykite.config.v1beta1.ReadOAuth2ProviderRequest
	88,  // 202: indykite.config.v1beta1.ConfigManagementAPI.UpdateOAuth2Provider:input_type -> indykite.config.v1beta1.UpdateOAuth2ProviderRequest
	90,  // 203: indykite.config.v1beta1.ConfigManagementAPI.DeleteOAuth2Provider:input_type -> indykite.config.v1beta1.DeleteOAuth2ProviderRequest
	92,  // 204: indykite.config.v1beta1.ConfigManagementAPI.CreateOAuth2Application:input_type -> indykite.config.v1beta1.CreateOAuth2ApplicationRequest
	94,  // 205: indykite.config.v1beta1.ConfigManagementAPI.ReadOAuth2Application:input_type -> indykite.config.v1beta1.ReadOAuth2ApplicationRequest
	96,  // 206: indykite.config.v1beta1.ConfigManagementAPI.UpdateOAuth2Application:input_type -> indykite.config.v1beta1.UpdateOAuth2ApplicationRequest
	98,  // 207: indykite.config.v1beta1.ConfigManagementAPI.DeleteOAuth2Application:input_type -> indykite.config.v1beta1.DeleteOAuth2ApplicationRequest
	100, // 208: indykite.config.v1beta1.ConfigManagementAPI.AssignPermissions:input_type -> indykite.config.v1beta1.AssignPermissionsRequest
	102, // 209: indykite.config.v1beta1.ConfigManagementAPI.RevokePermissions:input_type -> indykite.config.v1beta1.RevokePermissionsRequest
	104, // 210: indykite.config.v1beta1.ConfigManagementAPI.ListPermissions:input_type -> indykite.config.v1beta1.ListPermissionsRequest
	1,   // 211: indykite.config.v1beta1.ConfigManagementAPI.ReadCustomer:output_type -> indykite.config.v1beta1.ReadCustomerResponse
	3,   // 212: indykite.config.v1beta1.ConfigManagementAPI.ReadCustomerConfig:output_type -> indykite.config.v1beta1.ReadCustomerConfigResponse
	5,   // 213: indykite.config.v1beta1.ConfigManagementAPI.UpdateCustomerConfig:output_type -> indykite.config.v1beta1.UpdateCustomerConfigResponse
	7,   // 214: indykite.config.v1beta1.ConfigManagementAPI.CreateApplicationSpace:output_type -> indykite.config.v1beta1.CreateApplicationSpaceResponse
	9,   // 215: indykite.config.v1beta1.ConfigManagementAPI.ReadApplicationSpace:output_type -> indykite.config.v1beta1.ReadApplicationSpaceResponse
	11,  // 216: indykite.config.v1beta1.ConfigManagementAPI.ListApplicationSpaces:output_type -> indykite.config.v1beta1.ListApplicationSpacesResponse
	13,  // 217: indykite.config.v1beta1.ConfigManagementAPI.UpdateApplicationSpace:output_type -> indykite.config.v1beta1.UpdateApplicationSpaceResponse
	15,  // 218: indykite.config.v1beta1.ConfigManagementAPI.DeleteApplicationSpace:output_type -> indykite.config.v1beta1.DeleteApplicationSpaceResponse
	17,  // 219: indykite.config.v1beta1.ConfigManagementAPI.ReadApplicationSpaceConfig:output_type -> indykite.config.v1beta1.ReadApplicationSpaceConfigResponse
	19,  // 220: indykite.config.v1beta1.ConfigManagementAPI.UpdateApplicationSpaceConfig:output_type -> indykite.config.v1beta1.UpdateApplicationSpaceConfigResponse
	21,  // 221: indykite.config.v1beta1.ConfigManagementAPI.CreateApplication:output_type -> indykite.config.v1beta1.CreateApplicationResponse
	23,  // 222: indykite.config.v1beta1.ConfigManagementAPI.ReadApplication:output_type -> indykite.config.v1beta1.ReadApplicationResponse
	25,  // 223: indykite.config.v1beta1.ConfigManagementAPI.ListApplications:output_type -> indykite.config.v1beta1.ListApplicationsResponse
	27,  // 224: indykite.config.v1beta1.ConfigManagementAPI.UpdateApplication:output_type -> indykite.config.v1beta1.UpdateApplicationResponse
	29,  // 225: indykite.config.v1beta1.ConfigManagementAPI.DeleteApplication:output_type -> indykite.config.v1beta1.DeleteApplicationResponse
	31,  // 226: indykite.config.v1beta1.ConfigManagementAPI.CreateApplicationAgent:output_type -> indykite.config.v1beta1.CreateApplicationAgentResponse
	33,  // 227: indykite.config.v1beta1.ConfigManagementAPI.ReadApplicationAgent:output_type -> indykite.config.v1beta1.ReadApplicationAgentResponse
	35,  // 228: indykite.config.v1beta1.ConfigManagementAPI.ListApplicationAgents:output_type -> indykite.config.v1beta1.ListApplicationAgentsResponse
	37,  // 229: indykite.config.v1beta1.ConfigManagementAPI.UpdateApplicationAgent:output_type -> indykite.config.v1beta1.UpdateApplicationAgentResponse
	39,  // 230: indykite.config.v1beta1.ConfigManagementAPI.DeleteApplicationAgent:output_type -> indykite.config.v1beta1.DeleteApplicationAgentResponse
	41,  // 231: indykite.config.v1beta1.ConfigManagementAPI.RegisterApplicationAgentCredential:output_type -> indykite.config.v1beta1.RegisterApplicationAgentCredentialResponse
	43,  // 232: indykite.config.v1beta1.ConfigManagementAPI.ReadApplicationAgentCredential:output_type -> indykite.config.v1beta1.ReadApplicationAgentCredentialResponse
	45,  // 233: indykite.config.v1beta1.ConfigManagementAPI.DeleteApplicationAgentCredential:output_type -> indykite.config.v1beta1.DeleteApplicationAgentCredentialResponse
	47,  // 234: indykite.config.v1beta1.ConfigManagementAPI.CreateServiceAccount:output_type -> indykite.config.v1beta1.CreateServiceAccountResponse
	49,  // 235: indykite.config.v1beta1.ConfigManagementAPI.ReadServiceAccount:output_type -> indykite.config.v1beta1.ReadServiceAccountResponse
	51,  // 236: indykite.config.v1beta1.ConfigManagementAPI.UpdateServiceAccount:output_type -> indykite.config.v1beta1.UpdateServiceAccountResponse
	53,  // 237: indykite.config.v1beta1.ConfigManagementAPI.DeleteServiceAccount:output_type -> indykite.config.v1beta1.DeleteServiceAccountResponse
	55,  // 238: indykite.config.v1beta1.ConfigManagementAPI.RegisterServiceAccountCredential:output_type -> indykite.config.v1beta1.RegisterServiceAccountCredentialResponse
	57,  // 239: indykite.config.v1beta1.ConfigManagementAPI.ReadServiceAccountCredential:output_type -> indykite.config.v1beta1.ReadServiceAccountCredentialResponse
	59,  // 240: indykite.config.v1beta1.ConfigManagementAPI.DeleteServiceAccountCredential:output_type -> indykite.config.v1beta1.DeleteServiceAccountCredentialResponse
	61,  // 241: indykite.config.v1beta1.ConfigManagementAPI.CreateTenant:output_type -> indykite.config.v1beta1.CreateTenantResponse
	63,  // 242: indykite.config.v1beta1.ConfigManagementAPI.ReadTenant:output_type -> indykite.config.v1beta1.ReadTenantResponse
	65,  // 243: indykite.config.v1beta1.ConfigManagementAPI.ListTenants:output_type -> indykite.config.v1beta1.ListTenantsResponse
	67,  // 244: indykite.config.v1beta1.ConfigManagementAPI.UpdateTenant:output_type -> indykite.config.v1beta1.UpdateTenantResponse
	69,  // 245: indykite.config.v1beta1.ConfigManagementAPI.DeleteTenant:output_type -> indykite.config.v1beta1.DeleteTenantResponse
	71,  // 246: indykite.config.v1beta1.ConfigManagementAPI.ReadTenantConfig:output_type -> indykite.config.v1beta1.ReadTenantConfigResponse
	73,  // 247: indykite.config.v1beta1.ConfigManagementAPI.UpdateTenantConfig:output_type -> indykite.config.v1beta1.UpdateTenantConfigResponse
	75,  // 248: indykite.config.v1beta1.ConfigManagementAPI.CreateConfigNode:output_type -> indykite.config.v1beta1.CreateConfigNodeResponse
	77,  // 249: indykite.config.v1beta1.ConfigManagementAPI.ReadConfigNode:output_type -> indykite.config.v1beta1.ReadConfigNodeResponse
	79,  // 250: indykite.config.v1beta1.ConfigManagementAPI.UpdateConfigNode:output_type -> indykite.config.v1beta1.UpdateConfigNodeResponse
	83,  // 251: indykite.config.v1beta1.ConfigManagementAPI.DeleteConfigNode:output_type -> indykite.config.v1beta1.DeleteConfigNodeResponse
	82,  // 252: indykite.config.v1beta1.ConfigManagementAPI.ListConfigNodeVersions:output_type -> indykite.config.v1beta1.ListConfigNodeVersionsResponse
	85,  // 253: indykite.config.v1beta1.ConfigManagementAPI.CreateOAuth2Provider:output_type -> indykite.config.v1beta1.CreateOAuth2ProviderResponse
	87,  // 254: indykite.config.v1beta1.ConfigManagementAPI.ReadOAuth2Provider:output_type -> indykite.config.v1beta1.ReadOAuth2ProviderResponse
	89,  // 255: indykite.config.v1beta1.ConfigManagementAPI.UpdateOAuth2Provider:output_type -> indykite.config.v1beta1.UpdateOAuth2ProviderResponse
	91,  // 256: indykite.config.v1beta1.ConfigManagementAPI.DeleteOAuth2Provider:output_type -> indykite.config.v1beta1.DeleteOAuth2ProviderResponse
	93,  // 257: indykite.config.v1beta1.ConfigManagementAPI.CreateOAuth2Application:output_type -> indykite.config.v1beta1.CreateOAuth2ApplicationResponse
	95,  // 258: indykite.config.v1beta1.ConfigManagementAPI.ReadOAuth2Application:output_type -> indykite.config.v1beta1.ReadOAuth2ApplicationResponse
	97,  // 259: indykite.config.v1beta1.ConfigManagementAPI.UpdateOAuth2Application:output_type -> indykite.config.v1beta1.UpdateOAuth2ApplicationResponse
	99,  // 260: indykite.config.v1beta1.ConfigManagementAPI.DeleteOAuth2Application:output_type -> indykite.config.v1beta1.DeleteOAuth2ApplicationResponse
	101, // 261: indykite.config.v1beta1.ConfigManagementAPI.AssignPermissions:output_type -> indykite.config.v1beta1.AssignPermissionsResponse
	103, // 262: indykite.config.v1beta1.ConfigManagementAPI.RevokePermissions:output_type -> indykite.config.v1beta1.RevokePermissionsResponse
	105, // 263: indykite.config.v1beta1.ConfigManagementAPI.ListPermissions:output_type -> indykite.config.v1beta1.ListPermissionsResponse
	211, // [211:264] is the sub-list for method output_type
	158, // [158:211] is the sub-list for method input_type
