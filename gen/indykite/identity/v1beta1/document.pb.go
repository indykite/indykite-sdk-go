...
var file_indykite_identity_v1beta1_document_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x70, 0x65, 0x42, 0x87, 0x02, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x64,
...
var file_indykite_identity_v1beta1_document_proto_goTypes = []any{
...
func file_indykite_identity_v1beta1_document_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_indykite_identity_v1beta1_document_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_document_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_document_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_document_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Write); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indykite_identity_v1beta1_document_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_document_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_document_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_indykite_identity_v1beta1_document_proto_msgTypes[2].OneofWrappers = []any{
		(*Precondition_Exists)(nil),
		(*Precondition_UpdateTime)(nil),
	}
	file_indykite_identity_v1beta1_document_proto_msgTypes[3].OneofWrappers = []any{
		(*Write_Update)(nil),
		(*Write_Delete)(nil),
		(*Write_Transform)(nil),
	}
	file_indykite_identity_v1beta1_document_proto_msgTypes[7].OneofWrappers = []any{
