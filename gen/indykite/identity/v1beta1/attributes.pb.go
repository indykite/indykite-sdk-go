...
var file_indykite_identity_v1beta1_attributes_proto_rawDesc = []byte{
	...
	0x56, 0x45, 0x4c, 0x5f, 0x48, 0x49, 0x47, 0x48, 0x10, 0x03, 0x42, 0x89, 0x02, 0x0a, 0x1d, 0x63,
...
var file_indykite_identity_v1beta1_attributes_proto_goTypes = []any{
...
func file_indykite_identity_v1beta1_attributes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Schema); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_indykite_identity_v1beta1_attributes_proto_msgTypes[9].Exporter = func(v any, i int) any {
	...
	file_indykite_identity_v1beta1_attributes_proto_msgTypes[5].OneofWrappers = []any{
		(*Property_ObjectValue)(nil),
		(*Property_ReferenceValue)(nil),
	}
	file_indykite_identity_v1beta1_attributes_proto_msgTypes[6].OneofWrappers = []any{
		(*PropertyBatchOperation_Add)(nil),
		(*PropertyBatchOperation_Replace)(nil),
		(*PropertyBatchOperation_Remove)(nil),
	}
	file_indykite_identity_v1beta1_attributes_proto_msgTypes[7].OneofWrappers = []any{
