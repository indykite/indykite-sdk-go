...
func file_indykite_identity_v1beta2_attributes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_indykite_identity_v1beta2_attributes_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	file_indykite_identity_v1beta2_attributes_proto_msgTypes[8].OneofWrappers = []interface{}{
