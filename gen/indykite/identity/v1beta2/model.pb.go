...
func file_indykite_identity_v1beta2_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_indykite_identity_v1beta2_model_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_indykite_identity_v1beta2_model_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
	...
	file_indykite_identity_v1beta2_model_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*DigitalTwinIdentifier_DigitalTwin)(nil),
		(*DigitalTwinIdentifier_PropertyFilter)(nil),
		(*DigitalTwinIdentifier_AccessToken)(nil),
	}
	file_indykite_identity_v1beta2_model_proto_msgTypes[4].OneofWrappers = []interface{}{
