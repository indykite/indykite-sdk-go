...
func file_indykite_identity_v1beta2_identity_management_api_proto_init() {
	...
	file_indykite_identity_v1beta2_identity_management_api_proto_msgTypes[24].OneofWrappers = []interface{}{
		(*UpdatePasswordCredentialRequest_Email)(nil),
		(*UpdatePasswordCredentialRequest_Mobile)(nil),
	}
	file_indykite_identity_v1beta2_identity_management_api_proto_msgTypes[29].OneofWrappers = []interface{}{
		(*CreateInvitationRequest_Email)(nil),
		(*CreateInvitationRequest_Mobile)(nil),
	}
	file_indykite_identity_v1beta2_identity_management_api_proto_msgTypes[31].OneofWrappers = []interface{}{
	...
	file_indykite_identity_v1beta2_identity_management_api_proto_msgTypes[58].OneofWrappers = []interface{}{
