...
func (x *Subject) GetAccessToken() string {
	if x, ok := x.GetSubject().(*Subject_AccessToken); ok {
...
func (x *InputParam) GetTimeValue() *timestamppb.Timestamp {
	if x, ok := x.GetValue().(*InputParam_TimeValue); ok {
		return x.TimeValue
	}
	return nil
}
...
func (x *InputParam) GetDurationValue() *durationpb.Duration {
	if x, ok := x.GetValue().(*InputParam_DurationValue); ok {
...
func (x *InputParam) GetArrayValue() *v1beta2.Array {
	if x, ok := x.GetValue().(*InputParam_ArrayValue); ok {
		return x.ArrayValue
	}
	return nil
}
...
func (x *InputParam) GetMapValue() *v1beta2.Map {
	if x, ok := x.GetValue().(*InputParam_MapValue); ok {
		return x.MapValue
	}
	return nil
}
