...
type Record struct {
	...
	Data       map[string]*v1beta1.Value `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_indykite_ingest_v1beta1_model_proto_rawDesc = []byte{
	...
	0x01, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x2b, 0x0a, 0x0b, 0x65, 0x78, 0x74,
	...
	0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x52, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x69, 0x6e, 0x64, 0x79, 0x6b, 0x69, 0x74, 0x65, 0x2e,
	0x69, 0x6e, 0x67, 0x65, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x52,
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x42,
	0x13, 0xfa, 0x42, 0x10, 0x9a, 0x01, 0x0d, 0x08, 0x01, 0x10, 0x14, 0x22, 0x07, 0x72, 0x05, 0x10,
	0x01, 0x18, 0x80, 0x02, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x58, 0x0a, 0x09, 0x44, 0x61,
	...
	0x3a, 0x02, 0x38, 0x01, 0x42, 0xf4, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x64,
...
var file_indykite_ingest_v1beta1_model_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_indykite_ingest_v1beta1_model_proto_goTypes = []interface{}{
	(*Record)(nil),        // 0: indykite.ingest.v1beta1.Record
	nil,                   // 1: indykite.ingest.v1beta1.Record.DataEntry
	(*v1beta1.Value)(nil), // 2: indykite.objects.v1beta1.Value
}
var file_indykite_ingest_v1beta1_model_proto_depIdxs = []int32{
	1, // 0: indykite.ingest.v1beta1.Record.data:type_name -> indykite.ingest.v1beta1.Record.DataEntry
	2, // 1: indykite.ingest.v1beta1.Record.DataEntry.value:type_name -> indykite.objects.v1beta1.Value
