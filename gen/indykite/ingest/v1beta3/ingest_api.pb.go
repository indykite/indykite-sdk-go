...
const file_indykite_ingest_v1beta3_ingest_api_proto_rawDesc = "" +
	...
	"\x04info\x18\x05 \x01(\v2\x1d.indykite.ingest.v1beta3.InfoR\x04info2\xf4\t\n" +
	"\tIngestAPI\x12w\n" +
	...
	"\fIngestRecord\x12,.indykite.ingest.v1beta3.IngestRecordRequest\x1a-.indykite.ingest.v1beta3.IngestRecordResponse\"\x03\x88\x02\x01\x12|\n" +
	"\x10BatchUpsertNodes\x120.indykite.ingest.v1beta3.BatchUpsertNodesRequest\x1a1.indykite.ingest.v1beta3.BatchUpsertNodesResponse\"\x03\x88\x02\x01\x12\x94\x01\n" +
	"\x18BatchUpsertRelationships\x128.indykite.ingest.v1beta3.BatchUpsertRelationshipsRequest\x1a9.indykite.ingest.v1beta3.BatchUpsertRelationshipsResponse\"\x03\x88\x02\x01\x12|\n" +
	"\x10BatchDeleteNodes\x120.indykite.ingest.v1beta3.BatchDeleteNodesRequest\x1a1.indykite.ingest.v1beta3.BatchDeleteNodesResponse\"\x03\x88\x02\x01\x12\x94\x01\n" +
	"\x18BatchDeleteRelationships\x128.indykite.ingest.v1beta3.BatchDeleteRelationshipsRequest\x1a9.indykite.ingest.v1beta3.BatchDeleteRelationshipsResponse\"\x03\x88\x02\x01\x12\x97\x01\n" +
	"\x19BatchDeleteNodeProperties\x129.indykite.ingest.v1beta3.BatchDeleteNodePropertiesRequest\x1a:.indykite.ingest.v1beta3.BatchDeleteNodePropertiesResponse\"\x03\x88\x02\x01\x12\xaf\x01\n" +
	"!BatchDeleteRelationshipProperties\x12A.indykite.ingest.v1beta3.BatchDeleteRelationshipPropertiesRequest\x1aB.indykite.ingest.v1beta3.BatchDeleteRelationshipPropertiesResponse\"\x03\x88\x02\x01\x12\x85\x01\n" +
	"\x13BatchDeleteNodeTags\x123.indykite.ingest.v1beta3.BatchDeleteNodeTagsRequest\x1a4.indykite.ingest.v1beta3.BatchDeleteNodeTagsResponse\"\x03\x88\x02\x01B\xfa\x01\n" +
