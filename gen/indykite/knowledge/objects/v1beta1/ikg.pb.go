...
func file_indykite_knowledge_objects_v1beta1_ikg_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_indykite_knowledge_objects_v1beta1_ikg_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indykite_knowledge_objects_v1beta1_ikg_proto_msgTypes[1].Exporter = func(v any, i int) any {
