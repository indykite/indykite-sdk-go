...
const file_indykite_auditsink_v1beta1_ingest_proto_rawDesc = "" +
	...
	"\x04type\x18\x01 \x01(\tR\x04type\x12=\n" +
	"\x06source\x18\x02 \x01(\v2%.indykite.auditsink.v1beta1.NodeMatchR\x06source\x12=\n" +
	"\x06target\x18\x03 \x01(\v2%.indykite.auditsink.v1beta1.NodeMatchR\x06target\"@\n" +
	"\tNodeMatch\x12\x1f\n" +
	"\vexternal_id\x18\x01 \x01(\tR\n" +
	"externalId\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04typeB\x8c\x02\n" +
...
var file_indykite_auditsink_v1beta1_ingest_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_indykite_auditsink_v1beta1_ingest_proto_goTypes = []any{
	...
	(*DeleteData_NodePropertyMetadataMatch)(nil), // 16: indykite.auditsink.v1beta1.DeleteData.NodePropertyMetadataMatch
	(*DeleteData_RelationshipPropertyMatch)(nil), // 17: indykite.auditsink.v1beta1.DeleteData.RelationshipPropertyMatch
}
var file_indykite_auditsink_v1beta1_ingest_proto_depIdxs = []int32{
	...
	17, // 5: indykite.auditsink.v1beta1.BatchDeleteRelationshipProperties.relationship_properties:type_name -> indykite.auditsink.v1beta1.DeleteData.RelationshipPropertyMatch
	...
	17, // 12: indykite.auditsink.v1beta1.DeleteData.relationship_property:type_name -> indykite.auditsink.v1beta1.DeleteData.RelationshipPropertyMatch
	14, // 13: indykite.auditsink.v1beta1.DeleteData.node_tags:type_name -> indykite.auditsink.v1beta1.DeleteData.NodeTagMatch
	16, // 14: indykite.auditsink.v1beta1.DeleteData.node_property_metadata:type_name -> indykite.auditsink.v1beta1.DeleteData.NodePropertyMetadataMatch
	13, // 15: indykite.auditsink.v1beta1.Relationship.source:type_name -> indykite.auditsink.v1beta1.NodeMatch
	13, // 16: indykite.auditsink.v1beta1.Relationship.target:type_name -> indykite.auditsink.v1beta1.NodeMatch
	13, // 17: indykite.auditsink.v1beta1.DeleteData.NodeTagMatch.match:type_name -> indykite.auditsink.v1beta1.NodeMatch
	13, // 18: indykite.auditsink.v1beta1.DeleteData.NodePropertyMatch.match:type_name -> indykite.auditsink.v1beta1.NodeMatch
	13, // 19: indykite.auditsink.v1beta1.DeleteData.NodePropertyMetadataMatch.match:type_name -> indykite.auditsink.v1beta1.NodeMatch
	13, // 20: indykite.auditsink.v1beta1.DeleteData.RelationshipPropertyMatch.source:type_name -> indykite.auditsink.v1beta1.NodeMatch
	13, // 21: indykite.auditsink.v1beta1.DeleteData.RelationshipPropertyMatch.target:type_name -> indykite.auditsink.v1beta1.NodeMatch
