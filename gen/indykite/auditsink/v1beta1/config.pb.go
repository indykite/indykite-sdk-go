...
func (*EventSinkConfig_AzureServiceBusSinkConfig) Descriptor() ([]byte, []int) {
	return file_indykite_auditsink_v1beta1_config_proto_rawDescGZIP(), []int{10, 1}
}
...
func (*EventSinkConfig_AzureEventGridSinkConfig) Descriptor() ([]byte, []int) {
	return file_indykite_auditsink_v1beta1_config_proto_rawDescGZIP(), []int{10, 2}
}
...
func (*EventSinkConfig_Provider) Descriptor() ([]byte, []int) {
	return file_indykite_auditsink_v1beta1_config_proto_rawDescGZIP(), []int{10, 3}
}
...
func (*EventSinkConfig_Route) Descriptor() ([]byte, []int) {
	return file_indykite_auditsink_v1beta1_config_proto_rawDescGZIP(), []int{10, 4}
}
...
func (*EventSinkConfig_Route_KeyValue) Descriptor() ([]byte, []int) {
	return file_indykite_auditsink_v1beta1_config_proto_rawDescGZIP(), []int{10, 4, 0}
}
...
func (*TokenIntrospectConfig_Offline) Descriptor() ([]byte, []int) {
	return file_indykite_auditsink_v1beta1_config_proto_rawDescGZIP(), []int{15, 2}
}
...
func (*TokenIntrospectConfig_Online) Descriptor() ([]byte, []int) {
	return file_indykite_auditsink_v1beta1_config_proto_rawDescGZIP(), []int{15, 3}
}
...
func (*TokenIntrospectConfig_Claim) Descriptor() ([]byte, []int) {
	return file_indykite_auditsink_v1beta1_config_proto_rawDescGZIP(), []int{15, 4}
}
...
const file_indykite_auditsink_v1beta1_config_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12:\n" +
	"\x04type\x18\x02 \x01(\x0e2&.indykite.auditsink.v1beta1.ConfigTypeR\x04type\x12S\n" +
	"\x0fcontainers_path\x18\x03 \x01(\v2*.indykite.auditsink.v1beta1.ContainersPathR\x0econtainersPath\"\xca\x0e\n" +
	...
	"\rconfigurationJ\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\fJ\x04\b\r\x10\x0eJ\x04\b\x0e\x10\x0fJ\x04\b\x10\x10\x11J\x04\b\x11\x10\x12\"r\n" +
	"\x16ApplicationSpaceConfig\x12\x16\n" +
	"\x06region\x18\x01 \x01(\tR\x06region\x12\x19\n" +
	"\bikg_size\x18\x02 \x01(\tR\aikgSize\x12%\n" +
	"\x0ereplica_region\x18\x03 \x01(\tR\rreplicaRegion\"\xb3\x01\n" +
...
var file_indykite_auditsink_v1beta1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_indykite_auditsink_v1beta1_config_proto_goTypes = []any{
	...
	(*ApplicationSpaceConfig)(nil),                       // 15: indykite.auditsink.v1beta1.ApplicationSpaceConfig
	(*ApplicationAgentCredentialConfig)(nil),             // 16: indykite.auditsink.v1beta1.ApplicationAgentCredentialConfig
	(*ApplicationAgentConfig)(nil),                       // 17: indykite.auditsink.v1beta1.ApplicationAgentConfig
	(*ServiceAccountCredentialConfig)(nil),               // 18: indykite.auditsink.v1beta1.ServiceAccountCredentialConfig
	(*EventSinkConfig)(nil),                              // 19: indykite.auditsink.v1beta1.EventSinkConfig
	(*ExternalDataResolverConfig)(nil),                   // 20: indykite.auditsink.v1beta1.ExternalDataResolverConfig
	(*AuthorizationPolicyConfig)(nil),                    // 21: indykite.auditsink.v1beta1.AuthorizationPolicyConfig
	(*AssignConfigPermissions)(nil),                      // 22: indykite.auditsink.v1beta1.AssignConfigPermissions
	(*RevokeConfigPermissions)(nil),                      // 23: indykite.auditsink.v1beta1.RevokeConfigPermissions
	(*TokenIntrospectConfig)(nil),                        // 24: indykite.auditsink.v1beta1.TokenIntrospectConfig
	(*ConsentConfiguration)(nil),                         // 25: indykite.auditsink.v1beta1.ConsentConfiguration
	(*IngestPipelineConfig)(nil),                         // 26: indykite.auditsink.v1beta1.IngestPipelineConfig
	(*EntityMatchingPipelineConfig)(nil),                 // 27: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig
	(*TrustScoreDimension)(nil),                          // 28: indykite.auditsink.v1beta1.TrustScoreDimension
	(*TrustScoreProfileConfig)(nil),                      // 29: indykite.auditsink.v1beta1.TrustScoreProfileConfig
	(*KnowledgeQueryConfig)(nil),                         // 30: indykite.auditsink.v1beta1.KnowledgeQueryConfig
	(*CapturePipelineConfig)(nil),                        // 31: indykite.auditsink.v1beta1.CapturePipelineConfig
	(*CapturePipelineTopicConfig)(nil),                   // 32: indykite.auditsink.v1beta1.CapturePipelineTopicConfig
	(*CreatedConfig_Location)(nil),                       // 33: indykite.auditsink.v1beta1.CreatedConfig.Location
	(*ReadConfig_NameIdentifier)(nil),                    // 34: indykite.auditsink.v1beta1.ReadConfig.NameIdentifier
	(*EventSinkConfig_KafkaSinkConfig)(nil),              // 35: indykite.auditsink.v1beta1.EventSinkConfig.KafkaSinkConfig
	(*EventSinkConfig_AzureServiceBusSinkConfig)(nil),    // 36: indykite.auditsink.v1beta1.EventSinkConfig.AzureServiceBusSinkConfig
	(*EventSinkConfig_AzureEventGridSinkConfig)(nil),     // 37: indykite.auditsink.v1beta1.EventSinkConfig.AzureEventGridSinkConfig
	(*EventSinkConfig_Provider)(nil),                     // 38: indykite.auditsink.v1beta1.EventSinkConfig.Provider
	(*EventSinkConfig_Route)(nil),                        // 39: indykite.auditsink.v1beta1.EventSinkConfig.Route
	nil,                                                  // 40: indykite.auditsink.v1beta1.EventSinkConfig.ProvidersEntry
	(*EventSinkConfig_Route_KeyValue)(nil),               // 41: indykite.auditsink.v1beta1.EventSinkConfig.Route.KeyValue
	nil,                                                  // 42: indykite.auditsink.v1beta1.ExternalDataResolverConfig.HeadersEntry
	(*TokenIntrospectConfig_JWT)(nil),                    // 43: indykite.auditsink.v1beta1.TokenIntrospectConfig.JWT
	(*TokenIntrospectConfig_Opaque)(nil),                 // 44: indykite.auditsink.v1beta1.TokenIntrospectConfig.Opaque
	(*TokenIntrospectConfig_Offline)(nil),                // 45: indykite.auditsink.v1beta1.TokenIntrospectConfig.Offline
	(*TokenIntrospectConfig_Online)(nil),                 // 46: indykite.auditsink.v1beta1.TokenIntrospectConfig.Online
	...
	(*EntityMatchingPipelineConfig_NodeFilter)(nil),      // 49: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.NodeFilter
	(*EntityMatchingPipelineConfig_PropertyMapping)(nil), // 50: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.PropertyMapping
	(*CapturePipelineTopicConfig_Script)(nil),            // 51: indykite.auditsink.v1beta1.CapturePipelineTopicConfig.Script
...
var file_indykite_auditsink_v1beta1_config_proto_depIdxs = []int32{
	...
	33, // 1: indykite.auditsink.v1beta1.CreatedConfig.location:type_name -> indykite.auditsink.v1beta1.CreatedConfig.Location
	...
	34, // 4: indykite.auditsink.v1beta1.ReadConfig.name:type_name -> indykite.auditsink.v1beta1.ReadConfig.NameIdentifier
	...
	15, // 13: indykite.auditsink.v1beta1.ConfigDetail.application_space:type_name -> indykite.auditsink.v1beta1.ApplicationSpaceConfig
	17, // 14: indykite.auditsink.v1beta1.ConfigDetail.application_agent:type_name -> indykite.auditsink.v1beta1.ApplicationAgentConfig
	16, // 15: indykite.auditsink.v1beta1.ConfigDetail.application_agent_credential:type_name -> indykite.auditsink.v1beta1.ApplicationAgentCredentialConfig
	18, // 16: indykite.auditsink.v1beta1.ConfigDetail.service_account_credential:type_name -> indykite.auditsink.v1beta1.ServiceAccountCredentialConfig
	19, // 17: indykite.auditsink.v1beta1.ConfigDetail.event_sink_config:type_name -> indykite.auditsink.v1beta1.EventSinkConfig
	21, // 18: indykite.auditsink.v1beta1.ConfigDetail.authorization_policy_config:type_name -> indykite.auditsink.v1beta1.AuthorizationPolicyConfig
	24, // 19: indykite.auditsink.v1beta1.ConfigDetail.token_introspect_config:type_name -> indykite.auditsink.v1beta1.TokenIntrospectConfig
	20, // 20: indykite.auditsink.v1beta1.ConfigDetail.external_data_resolver_config:type_name -> indykite.auditsink.v1beta1.ExternalDataResolverConfig
	29, // 21: indykite.auditsink.v1beta1.ConfigDetail.trust_score_profile_config:type_name -> indykite.auditsink.v1beta1.TrustScoreProfileConfig
	25, // 22: indykite.auditsink.v1beta1.ConfigDetail.consent_config:type_name -> indykite.auditsink.v1beta1.ConsentConfiguration
	26, // 23: indykite.auditsink.v1beta1.ConfigDetail.ingest_pipeline_config:type_name -> indykite.auditsink.v1beta1.IngestPipelineConfig
	27, // 24: indykite.auditsink.v1beta1.ConfigDetail.entity_matching_pipeline_config:type_name -> indykite.auditsink.v1beta1.EntityMatchingPipelineConfig
	30, // 25: indykite.auditsink.v1beta1.ConfigDetail.knowledge_query_config:type_name -> indykite.auditsink.v1beta1.KnowledgeQueryConfig
	31, // 26: indykite.auditsink.v1beta1.ConfigDetail.capture_pipeline_config:type_name -> indykite.auditsink.v1beta1.CapturePipelineConfig
	32, // 27: indykite.auditsink.v1beta1.ConfigDetail.capture_pipeline_topic_config:type_name -> indykite.auditsink.v1beta1.CapturePipelineTopicConfig
	52, // 28: indykite.auditsink.v1beta1.ApplicationAgentCredentialConfig.expire_time:type_name -> google.protobuf.Timestamp
	52, // 29: indykite.auditsink.v1beta1.ServiceAccountCredentialConfig.expire_time:type_name -> google.protobuf.Timestamp
	40, // 30: indykite.auditsink.v1beta1.EventSinkConfig.providers:type_name -> indykite.auditsink.v1beta1.EventSinkConfig.ProvidersEntry
	39, // 31: indykite.auditsink.v1beta1.EventSinkConfig.routes:type_name -> indykite.auditsink.v1beta1.EventSinkConfig.Route
	42, // 32: indykite.auditsink.v1beta1.ExternalDataResolverConfig.headers:type_name -> indykite.auditsink.v1beta1.ExternalDataResolverConfig.HeadersEntry
	3,  // 33: indykite.auditsink.v1beta1.ExternalDataResolverConfig.request_type:type_name -> indykite.auditsink.v1beta1.ExternalDataResolverConfig.ContentType
	3,  // 34: indykite.auditsink.v1beta1.ExternalDataResolverConfig.response_type:type_name -> indykite.auditsink.v1beta1.ExternalDataResolverConfig.ContentType
	4,  // 35: indykite.auditsink.v1beta1.AuthorizationPolicyConfig.status:type_name -> indykite.auditsink.v1beta1.AuthorizationPolicyConfig.Status
	0,  // 36: indykite.auditsink.v1beta1.AssignConfigPermissions.target_type:type_name -> indykite.auditsink.v1beta1.ConfigType
	0,  // 37: indykite.auditsink.v1beta1.AssignConfigPermissions.object_type:type_name -> indykite.auditsink.v1beta1.ConfigType
	0,  // 38: indykite.auditsink.v1beta1.RevokeConfigPermissions.target_type:type_name -> indykite.auditsink.v1beta1.ConfigType
	0,  // 39: indykite.auditsink.v1beta1.RevokeConfigPermissions.object_type:type_name -> indykite.auditsink.v1beta1.ConfigType
	43, // 40: indykite.auditsink.v1beta1.TokenIntrospectConfig.jwt:type_name -> indykite.auditsink.v1beta1.TokenIntrospectConfig.JWT
	44, // 41: indykite.auditsink.v1beta1.TokenIntrospectConfig.opaque:type_name -> indykite.auditsink.v1beta1.TokenIntrospectConfig.Opaque
	45, // 42: indykite.auditsink.v1beta1.TokenIntrospectConfig.offline:type_name -> indykite.auditsink.v1beta1.TokenIntrospectConfig.Offline
	46, // 43: indykite.auditsink.v1beta1.TokenIntrospectConfig.online:type_name -> indykite.auditsink.v1beta1.TokenIntrospectConfig.Online
	48, // 44: indykite.auditsink.v1beta1.TokenIntrospectConfig.claims_mapping:type_name -> indykite.auditsink.v1beta1.TokenIntrospectConfig.ClaimsMappingEntry
	1,  // 45: indykite.auditsink.v1beta1.ConsentConfiguration.token_status:type_name -> indykite.auditsink.v1beta1.ExternalTokenStatus
	2,  // 46: indykite.auditsink.v1beta1.IngestPipelineConfig.operations:type_name -> indykite.auditsink.v1beta1.IngestPipelineOperation
	49, // 47: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.node_filter:type_name -> indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.NodeFilter
	5,  // 48: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.property_mapping_status:type_name -> indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.Status
	53, // 49: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.property_mapping_message:type_name -> google.protobuf.StringValue
	5,  // 50: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.entity_matching_status:type_name -> indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.Status
	53, // 51: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.entity_matching_message:type_name -> google.protobuf.StringValue
	50, // 52: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.property_mappings:type_name -> indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.PropertyMapping
	52, // 53: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.last_run_time:type_name -> google.protobuf.Timestamp
	53, // 54: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.report_url:type_name -> google.protobuf.StringValue
	53, // 55: indykite.auditsink.v1beta1.EntityMatchingPipelineConfig.report_type:type_name -> google.protobuf.StringValue
	6,  // 56: indykite.auditsink.v1beta1.TrustScoreDimension.name:type_name -> indykite.auditsink.v1beta1.TrustScoreDimension.Name
	28, // 57: indykite.auditsink.v1beta1.TrustScoreProfileConfig.dimensions:type_name -> indykite.auditsink.v1beta1.TrustScoreDimension
	7,  // 58: indykite.auditsink.v1beta1.TrustScoreProfileConfig.schedule:type_name -> indykite.auditsink.v1beta1.TrustScoreProfileConfig.UpdateFrequency
	8,  // 59: indykite.auditsink.v1beta1.KnowledgeQueryConfig.status:type_name -> indykite.auditsink.v1beta1.KnowledgeQueryConfig.Status
	51, // 60: indykite.auditsink.v1beta1.CapturePipelineTopicConfig.script:type_name -> indykite.auditsink.v1beta1.CapturePipelineTopicConfig.Script
	0,  // 61: indykite.auditsink.v1beta1.CreatedConfig.Location.type:type_name -> indykite.auditsink.v1beta1.ConfigType
	0,  // 62: indykite.auditsink.v1beta1.ReadConfig.NameIdentifier.location_type:type_name -> indykite.auditsink.v1beta1.ConfigType
	35, // 63: indykite.auditsink.v1beta1.EventSinkConfig.Provider.kafka:type_name -> indykite.auditsink.v1beta1.EventSinkConfig.KafkaSinkConfig
	36, // 64: indykite.auditsink.v1beta1.EventSinkConfig.Provider.azure_service_bus:type_name -> indykite.auditsink.v1beta1.EventSinkConfig.AzureServiceBusSinkConfig
	37, // 65: indykite.auditsink.v1beta1.EventSinkConfig.Provider.azure_event_grid:type_name -> indykite.auditsink.v1beta1.EventSinkConfig.AzureEventGridSinkConfig
	41, // 66: indykite.auditsink.v1beta1.EventSinkConfig.Route.context_key_value:type_name -> indykite.auditsink.v1beta1.EventSinkConfig.Route.KeyValue
	38, // 67: indykite.auditsink.v1beta1.EventSinkConfig.ProvidersEntry.value:type_name -> indykite.auditsink.v1beta1.EventSinkConfig.Provider
	54, // 68: indykite.auditsink.v1beta1.TokenIntrospectConfig.Online.cache_ttl:type_name -> google.protobuf.Duration
	47, // 69: indykite.auditsink.v1beta1.TokenIntrospectConfig.ClaimsMappingEntry.value:type_name -> indykite.auditsink.v1beta1.TokenIntrospectConfig.Claim
...
func file_indykite_auditsink_v1beta1_config_proto_init() {
	...
	file_indykite_auditsink_v1beta1_config_proto_msgTypes[15].OneofWrappers = []any{
