...
func file_indykite_auditsink_v1beta1_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_indykite_auditsink_v1beta1_config_proto_msgTypes[16].Exporter = func(v any, i int) any {
			switch v := v.(*EntityMatchingPipelineConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indykite_auditsink_v1beta1_config_proto_msgTypes[27].Exporter = func(v any, i int) any {
			switch v := v.(*EntityMatchingPipelineConfig_NodeFilter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indykite_auditsink_v1beta1_config_proto_msgTypes[28].Exporter = func(v any, i int) any {
			switch v := v.(*EntityMatchingPipelineConfig_PropertyMapping); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
