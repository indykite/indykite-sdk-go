...
// Validate checks the field values on DataAccessResponse_Node with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *DataAccessResponse_Node) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on DataAccessResponse_Node with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// DataAccessResponse_NodeMultiError, or nil if none found.
func (m *DataAccessResponse_Node) ValidateAll() error {
	return m.validate(true)
}

func (m *DataAccessResponse_Node) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, DataAccessResponse_NodeValidationError{
					field:  "Node",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return DataAccessResponse_NodeValidationError{
				field:  "Node",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return DataAccessResponse_NodeMultiError(errors)
	}

	return nil
}

// DataAccessResponse_NodeMultiError is an error wrapping multiple validation
// errors returned by DataAccessResponse_Node.ValidateAll() if the designated
// constraints aren't met.
type DataAccessResponse_NodeMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DataAccessResponse_NodeMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DataAccessResponse_NodeMultiError) AllErrors() []error { return m }

// DataAccessResponse_NodeValidationError is the validation error returned by
// DataAccessResponse_Node.Validate if the designated constraints aren't met.
type DataAccessResponse_NodeValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e DataAccessResponse_NodeValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e DataAccessResponse_NodeValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e DataAccessResponse_NodeValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e DataAccessResponse_NodeValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e DataAccessResponse_NodeValidationError) ErrorName() string {
	return "DataAccessResponse_NodeValidationError"
}

// Error satisfies the builtin error interface
func (e DataAccessResponse_NodeValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sDataAccessResponse_Node.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = DataAccessResponse_NodeValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = DataAccessResponse_NodeValidationError{}
