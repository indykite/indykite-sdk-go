...
type Client struct {
	...
	// The gRPC API client.
	client accesspb.TrustedDataControlAPIClient
...
func NewClient(ctx context.Context, opts ...api.ClientOption) (*Client, error) {
	...
	c := &Client{
		...
		client:       accesspb.NewTrustedDataControlAPIClient(connPool),
...
func NewTestClient(client accesspb.TrustedDataControlAPIClient) (*Client, error) {
	c := &Client{
