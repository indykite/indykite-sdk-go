...
//go:generate mockgen -copyright_file ./doc/LICENSE -package access -destination ./test/trusted_data/access/v1beta1/trusted_data_access_api_mock.go github.com/indykite/indykite-sdk-go/gen/indykite/trusted_data/access/v1beta1 TrustedDataControlAPIClient
