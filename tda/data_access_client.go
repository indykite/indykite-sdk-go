...
import (
	...
	accesspb "github.com/indykite/indykite-sdk-go/gen/indykite/tda/v1beta1"
...
type Client struct {
	...
	// The gRPC API client.
	client accesspb.TrustedDataAccessAPIClient
...
func NewClient(ctx context.Context, opts ...api.ClientOption) (*Client, error) {
	...
	c := &Client{
		...
		client:       accesspb.NewTrustedDataAccessAPIClient(connPool),
