...
// NewV2Client creates a new Ingest API gRPC Client.
func NewV2Client(ctx context.Context, opts ...api.ClientOption) (*V2Client, error) {
...
func NewTestClient(client ingestpb.IngestAPIClient) (*V2Client, error) {
	c := &V2Client{
